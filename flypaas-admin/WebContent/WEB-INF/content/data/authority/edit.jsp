...
<body>
      <div class="main_ctn">
        ...
        <form method="post" id="mainForm">
          <p><u:radio name="administrator_type" value="${data.role_id}" dictionaryType="administrator_type" callback="changeAdministratorType"/></p>
...
function changeAdministratorType(value, text){
	window.location.href="/authority/edit?role_id="+value;
}
