<div class="pagenum">
	...
	<#if (page.totalPage>1)>
		<#if (page.currentPage>1)>
			<a href="javascript:;" class="first" title="第一页" onclick="${formId}_getPage(1)">&nbsp;</a>
			<a href="javascript:;" class="prev" title="上一页" onclick="${formId}_getPage(${(page.currentPage-1) ?c})">&nbsp;</a>
		</#if>
		<#if (page.currentPage<page.totalPage)>
			<a href="javascript:;" class="next" title="下一页" onclick="${formId}_getPage(${(page.currentPage+1) ?c})">&nbsp;</a>
			<a href="javascript:;" class="last" title="最后一页" onclick="${formId}_getPage(${page.totalPage ?c})"></a>
		</#if>
		<span>
...
<script type="text/javascript">
	...
	function ${formId}_getPage(currentPage){
		if(/^[1-9]\d*$/.test(currentPage)){
			$("#${formId}_currentPage").val(currentPage);
		}
