package com.flypaas.admin.util.api;
...
import com.flypaas.admin.util.rest.SSLHttpClient;
...
public class RestUtils {
	...
	/**
	 * 调用线上环境的rest接口，即rest接口的域名为https://api.flypaas.com
	 * 
	 * @param contentType
	 * @param url
	 * @param auth
	...
	/**
	 * 调用非线上环境的rest接口，即rest接口的域名不为https://api.flypaas.com
	 * 
	 * @param contentType
	 * @param url
	 * @param auth
	...
	public static void main(String[] args) {
		ConfigUtils.rest_domain = "https://api.flypaas.com";
