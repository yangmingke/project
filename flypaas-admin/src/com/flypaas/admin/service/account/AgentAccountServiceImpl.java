...
public class AgentAccountServiceImpl implements AgentAccountService {
	...
	public PageContainer query(Map<String, String> params) {
		...
		return dao.getSearchPage("agentAccount.query", "agentAccount.queryCount", params);
	}
	...
	public Map<String, Object> view(String sid, Map<String, String> rechargeParams,
		...
		Map<String, Object> account = dao.getOneInfo("developerAccount.getAccount", data);// 获取代理商账务
		if (account != null) {
	...
	public Map<String, Object> updateEnableFlag(String sid, Map<String, String> params) {
		...
		if (tmp > 0) {
			...
			if ((BillConstant.ENABLE_FLAG_CANCELLED + "").equals(enableFlag)
				...
				Map<String, Object> account = dao.getOneInfo("developerAccount.getAccount", pp);// 获取代理商账务
		...
		logService.add(LogType.update, "账务管理-代理商账务：状态变更 ：" + msg, params, data);
		return data;
	}
	...
	public Map<String, Object> updateBalance(String sid, Map<String, String> params) {
		...
		logService.add(LogType.update, "账务管理-代理商账务：余额变更 ：" + msg, params, data);
		return data;
	}
	...
	public Map<String, Object> saveCreditBalance(Map<String, String> params) {
		...
		logService.add(LogType.update, "账务管理-代理商账务：设置信用额度" , params, data);
		return data;
	}
}
