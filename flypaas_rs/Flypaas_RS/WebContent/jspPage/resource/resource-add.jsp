...
<div class="pd-20">
  <div class="Huiform">
    <form action="##" method="post" id="formId">
      <table class="table table-bg" style="font-size: 12px; line-height: 30px;" >
        <tbody>
        
          <tr>
            <th width="120" class="text-r">资源名称：</th> 
            <td><input type="text" style="width:400px" class="input-text" value="" placeholder="" id="nameId" name="name"></td>
          </tr> 
          <tr>
            <th class="text-r">节点公网IP：</th>
            <td><input type="text" style="width:400px" class="input-text" value="" placeholder="" id="ipId" name="ip"></td>
          </tr>
          <!-- <tr>
          ...
          <tr>
            <th class="text-r">运营商：</th>
             <td>
             	<select class="select" size="1" name="operator" style="width: 200px;">
					<option value="0" selected>--请选择运营商--</option>
					<c:forEach var="list" items="${ispList}">
						<option value="${list.ispid}">${list.name}</option>
					</c:forEach>
				</select>
			</td>
          </tr>
          ...
          <!-- <tr>
            <th class="text-r">网络层级：</th>
             <td>
             	<select class="select" size="1" name="netLevel">
          ...
          <tr id="blockTr" style="display: none;">
          	...
          	<td>
          	 <div id="d1">
          		...
          		<div id="div1">
            	 <select style="width: 100px" name="startTime1">
            		<option value="" selected="selected">--请选择时间段--</option>
            		<option value=0000>00:00</option><option value=0100>01:00</option><option value=0200>02:00</option><option value=0300>03:00</option>
            		<option value=0400>04:00</option><option value=0500>05:00</option><option value=0600>06:00</option><option value=0700>07:00</option>
            		<option value=0800>08:00</option><option value=0900>09:00</option><option value=1000>10:00</option><option value=1100>11:00</option>
            		<option value=1200>12:00</option><option value=1300>13:00</option><option value=1400>17:00</option><option value=1500>15:00</option>
            		<option value=1600>16:00</option><option value=1700>17:00</option><option value=1800>18:00</option><option value=1900>19:00</option>
            		<option value=2000>20:00</option><option value=2100>21:00</option><option value=2200>22:00</option><option value=2300>13:00</option>
            	  </select>&nbsp;--&nbsp;
            	  <select style="width: 100px" name="endTime1">
            	  <option value="" selected="selected">--请选择时间段--</option>
            		<option value=0000>00:00</option><option value=0100>01:00</option><option value=0200>02:00</option><option value=0300>03:00</option>
            		<option value=0400>04:00</option><option value=0500>05:00</option><option value=0600>06:00</option><option value=0700>07:00</option>
            		<option value=0800>08:00</option><option value=0900>09:00</option><option value=1000>10:00</option><option value=1100>11:00</option>
            	  ...
            	  <input type="text" name="price1" placeholder="请填入价格" style="width: 70px" /><div><br/></div>
            	  </div>
            	</div>
            </td>
          </tr>
          ...
          <!-- <tr>
           <th class="text-r"></th>
            <td align="center">
            	<button class="btn btn-success radius" id ="onSub" type="submit"><i class="icon-ok"></i> 确定</button>
            </td>
          </tr> -->
        </tbody>
      </table>
    </form>
    <div style="margin-left: 40%"><button class="btn btn-success radius" id ="onSub"><i class="icon-ok"></i> 确定</button></div>
  </div>
</div>
...
$('#country').change(function(){
	...
	$.post("/cityController/queryProvinceByCountryId.action",{"countryId":countryId},function(data){
		var obj = eval("(" + data + ")");
		var json = eval("(" + obj + ")");
...
$('#province').change(function(){
	...
	$.post("/cityController/queryCityBypId.action",{"provinceId":provinceId},function(data){
		var obj = eval("(" + data + ")");
		var json = eval("(" + obj + ")");
