...
public class SysConstant {
	...
	//提现状态
		//未审核
		public static final String BILL_FLOW_NOT_AUDITED="0";
		//审核通过
		public static final String BILL_FLOW_PASS="1";
		//审核不通过
		public static final String BILL_FLOW_FAILED="2";
		//作废
		public static final String BILL_FLOW_INVALID="3";
		//已转账
		public static final String BILL_FLOW_SUCCESS="4";
...
//菜单id
	public static List<Integer> removePublicNetMenu = new ArrayList<Integer>();
	public static List<Integer> removePrivateNetMenu = new ArrayList<Integer>();
    static{
    	...
    	removePrivateNetMenu.addAll(Arrays.asList(401,402,403));
    	removePublicNetMenu.addAll(Arrays.asList(404));
    }
}
