...
public class SmsServiceImpl implements SmsService {
	...
	public PageContainer query(Map<String, String> params) {
		...
		List<String> data = commonService.getExistTable(TablePrefix.tb_sms_log_, params.get("start_date"),
				params.get("end_date"));
		if (data.size() > 0) {
			Map<String, Object> p = new HashMap<String, Object>();
			p.putAll(params);
			p.put("table_list", data);
			page = dao.getSearchPage("sms.query", "sms.queryCount", p);
		}
		return page;
	}
	...
	public Map<String, Object> view(Map<String, String> params) {
		return dao.getOneInfo("sms.view", params);
	}
}
