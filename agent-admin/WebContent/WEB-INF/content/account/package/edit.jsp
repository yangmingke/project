			    ...
			    <s:iterator value="data.fee_list" status="s">
			    	<s:if test="#s.index == data.fee_list.size/2">
					    ...
					    <ul class="ul_right">
					    	<li>
						    	<label>套餐类型</label>
						    	<u:radio name="package_type" value="${data.package_type}" dictionaryType="package_type" excludeValue="" />
					    	</li>
					    	<li id="li_charge_type">
						    	<label>付费类型</label>
						    	<u:radio name="charge_type" value="${data.charge_type}" dictionaryType="pay_type" excludeValue="" />
					    	</li>
			    	</s:if>
