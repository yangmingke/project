...
<body>
	<h1><a href="javascript:;" class="back" onclick="back2query('${ctx}/developerAccount/query','_dev_bill_form');">返 回</a>开发者账务信息/开发者账务明细</h1>
    <div class="main_ctn1 account_detail">
    <ul class="ul_left">
    <li><label>钱包编号</label><span>${data.account.acct_id}</span></li>
    <li><label>开发者账号</label><span class="v_data" tit="v_email">${data.account.email}</span></li>
