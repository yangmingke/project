      ...
      <div class="main_ctn">
        ...
        <div class="admin_material admin_form">
          <form method="post" id="mainForm">
          	...
          	<p>
              <label>用户帐号</label>
              <input type="text" name="uid" value="${data.uid}" onfocus="inputControl.setNumber(this, 50, 0, false)"/>
              client_number
            </p>
            ...
            <p>
              <label>系统版本号</label>
              <input type="text" name="osv" value="${data.osv==null ? 'ALL' : data.osv}" maxlength="50"/>
              2.1 默认值：ALL
            </p>
            <p>
              <label>品牌</label>
              <input type="text" name="brand" value="${data.brand==null ? 'ALL' : data.brand}" maxlength="50"/>
              Htc、huawei 默认值：ALL
            </p>
            <p>
              <label>型号</label>
              <input type="text" name="model" value="${data.model==null ? 'ALL' : data.model}" maxlength="50"/>
              	例如HTC的G10、G11等，默认值ALL
            </p>
            <p>
              <label>P2P探测使能</label>
