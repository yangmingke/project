...
<u:authority menuId="266">
	<s:set var="menuId_266" value="true"/>
</u:authority>
<u:authority menuId="267">
	<s:set var="menuId_267" value="true"/>
</u:authority>
<u:authority menuId="268">
	<s:set var="menuId_268" value="true"/>
</u:authority>

<html>
<head>
	<title>音频驱动适配清单列表</title>
</head>
...
<body>
   ...
   <form method="post" id="mainForm" action="${ctx}/voiceDevice/query">
   <ul>
   <li>
...
//添加
function add(){
	location.href="${ctx}/voiceDevice/add";
}

//查看
function view(id){
	location.href="${ctx}/voiceDevice/view?id=" + id;
}

//编辑
function edit(id){
	location.href="${ctx}/voiceDevice/edit?id=" + id;
}
