      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title">
			 ...
			 <h5></h5>
				<div class="search">
					<form method="post" id="qualityForm" action="${ctx}/throughput/viewDiagrm">
          ...
          <div class="widget-content nopadding">
				<u:highstock highstock="${data.chart}" id="chart"  onLoad="chartOnLoad"/><!-- onLoad="chartOnLoad" -->
		  </div> 
	...
	function chartOnLoad(){
		...
		if(sr_id && dst_sr_id){
			setInterval(function () {
				$.ajax({
					type : "post",
					url : "${ctx}/throughput/realviewThroughput",
