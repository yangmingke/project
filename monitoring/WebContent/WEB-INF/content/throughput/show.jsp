		...
		<div class="row-fluid">
			<div class="span12">
				...
				<ul class="nav nav-tabs" style="margin: 0px;">
					<li class="active">
						<a href="#panel-125117" data-toggle="tab">中国</a>
					</li>
					<li>
						<a href="#panel-835071" data-toggle="tab" onclick="window.location.href='${ctx}/throughput/showworld'">世界</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="panel-125117">
						 <div class="widget-box" style="margin: 0px;">
					          <div class="widget-title">
								 ...
								 <h5></h5>
									<div class="search">
										<form method="post" id="nodeForm" action="${ctx}/throughput/show">
										<input type="hidden" id="hiddenId" name="dst_id"  value="${param.dst_sr_id}"/>
											<ul> 
					                            ...
					                            <input type="text" value="<s:property value="data.end_time"/>" name="end_time" style="width:150px;" disabled="disabled"/></li>
					...
					<div class="tab-pane" id="panel-835071">
	...
	<script type="text/javascript">
		...
		function loadData(option, myChart) {
			$
					.ajax({
						type : 'post',
						url : '${ctx}/throughput/drawThroughputChina',
						data : $('#nodeForm').serialize(),
						async : false,
						datatype : 'json',
						error : function() {
