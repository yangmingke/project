...
<!--Action boxes-->
      ...
      <div class="span12">
       		<div class="tabbable" id="tabs-578884">
				<ul class="nav nav-tabs" style="margin: 0px;">
					...
					<li >
						<a href="#panel-835071" data-toggle="tab" onclick="window.location.href='${ctx}/network/topologyworld'" >世界</a>
					</li>
				</ul>
					...
					<div class="tab-pane  active" id="panel-125117" >
						 <div class="widget-box" style="margin: 0px;">
					          <div class="widget-title">
								 ...
								 <div class="search">
										<form method="post" id="nodeForm" action="${ctx}/network/topology">
											<ul> 
											    <li>
 ...
 <script type="text/javascript">
        ...
        function loadData(option,myChart,nodeList){
            ...
            $.ajax({
				type:'post',
				url:'${ctx}/network/getChinaTopology',
				data:$('#nodeForm').serialize(),
				async:false,
				datatype:'json',
				error:function(){}, //非必须
