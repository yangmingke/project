      ...
      <div class="span12">
      		<div class="tabbable" id="tabs-578884">
				<ul class="nav nav-tabs" style="margin: 0px;">
					...
					<li >
						<a href="#panel-835071" data-toggle="tab" onclick="window.location.href='${ctx}/link/qualityworld'">世界</a>
					</li>
				</ul>
					...
					<div class="tab-pane active" id="panel-125117">
						 <div class="widget-box" style="margin: 0px;">
					          <div class="widget-title">
								 ...
								 <h5></h5>
									<div class="search">
										<form method="post" id="nodeForm" action="${ctx}/link/quality">
