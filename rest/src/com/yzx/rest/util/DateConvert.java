...
public class DateConvert {
	...
	public static String dateAddDay(String date, int day) {
		Date date2=convertS2Date(date, "yyyyMMdd");
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date2);
		calendar.add(Calendar.DAY_OF_MONTH, day);
		return convertD2String(calendar.getTime(),"yyyyMMdd");
	}
	public static String dateAddDay2(String date, int day) {
		Date date2=convertS2Date(date, "yyyyMMddHH");
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date2);
		calendar.add(Calendar.DAY_OF_MONTH, day);
		return convertD2String(calendar.getTime(),"yyyyMMddHH");
	}
	/**
	 * 获取date所在的自然周的上周一
	 * @param date
	 * @return
	 */
	public static String getPrivFirstDateOfWeek(String date,int ly) {
		Date date2=convertS2Date(date, "yyyyMMdd");
		Calendar c = new GregorianCalendar();
    	c.setFirstDayOfWeek(Calendar.MONDAY);
    	c.setTime(date2);
    	c.add(Calendar.WEEK_OF_MONTH, ly);
    	c.set(Calendar.DAY_OF_WEEK, c.getFirstDayOfWeek());
    	c.set(Calendar.HOUR_OF_DAY, 0);
    	c.set(Calendar.MINUTE, 0);
    	c.set(Calendar.SECOND, 0);
    	return convertD2String(c.getTime(),"yyyyMMdd");
	}
	 ...
	 * @return
	 */
	public static String getPrivLastDateOfWeek(String date,int ly) {
		Date date2=convertS2Date(date, "yyyyMMdd");
		Calendar c = new GregorianCalendar();
    	c.setFirstDayOfWeek(Calendar.MONDAY);
    	c.setTime(date2);
	...
	public static String getFirstDateOfMonth(String date) {
		Date date2=convertS2Date(date, "yyyyMMdd");
		SimpleDateFormat sdDateFormat=new SimpleDateFormat("yyyyMMdd");
		Calendar c = new GregorianCalendar();
    	c.setTime(date2);
    	c.set(GregorianCalendar.DAY_OF_MONTH, 1); 
    	return sdDateFormat.format(c.getTime());
	}
	public static String getMonth(String date,int ly){
		Date date2=convertS2Date(date, "yyyyMMdd");
		SimpleDateFormat sdDateFormat=new SimpleDateFormat("yyyyMM");
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(date2);
		calendar.add(Calendar.MONTH, ly);
		return sdDateFormat.format(calendar.getTime());
	}
	public static void main(String[] args) {
//		Date temp = convertS2Date("2014-4-20 11:25:54", "yyyy-MM-dd HH:mm:ss");
//		Date end = convertS2Date("2014-4-29 10:45:25", "yyyy-MM-dd HH:mm:ss");
...
//		System.out.println(getMonth("20140403",0));
//		System.out.println(getPrivFirstDateOfWeek("20140625",0));
//		System.out.println(getPrivFirstDateOfWeek("20140626",-1));
//		System.out.println(getPrivLastDateOfWeek("20140626",-1));
//		System.out.println(dateAddDay("20140429",-1));
//		System.out.println(convertD2String(new Date(),"yyyyMMdd"));
		System.out.println(getFirstDateOfMonth("20140531"));
	}
