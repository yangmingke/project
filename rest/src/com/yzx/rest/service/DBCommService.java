...
//import com.yzx.rest.bean.ClientFee;
...
public class DBCommService{
	...
	public List<Map<String,String>> setDspList() {
		String sql="select * from tb_user_dsp where stype=1 and `status`=1 ";
		return queryForListStr(sql,null,Consts.CON_SLAVE);
	}
	public boolean isDsp(String sid){
		List<Map<String,String>> dspList=setDspList();
	 ...
	 public int update(String sql,List<Object[]> paramList){
	        ...
	        try {
	        	conn = DBUtil.getInstance().getConnection(Consts.CON_MASTER);
	        	logger.debug(sql);
	            ...
	            if (paramList!=null&&paramList.size()>0) {
	            	for (int i = 1; i <=paramList.size(); i++) {
	            		...
	            		if (objects[0].equals("number")) {
							pstmt.setLong(i, Long.parseLong(objects[1]==null?"0":objects[1].toString()));
						}else if (objects[0].equals("string")) {
							pstmt.setString(i, objects[1]==null?"":objects[1].toString());
						}
	    			}
				}
  ...
  * @return
  */
 public List<Map<String,Object>> queryForList(String sql,List<Object[]> paramList,String conPoolName){
 	Connection conn = null;
     PreparedStatement pstmt = null;
     ResultSet rs = null;
     List<Map<String,Object>> resultList=new ArrayList<Map<String,Object>>();
     try{
     	conn = DBUtil.getInstance().getConnection(conPoolName);
     	logger.debug(sql);
         pstmt = conn.prepareStatement(sql);
         if (paramList!=null&&paramList.size()>0) {
         	for (int i = 1; i <=paramList.size(); i++) {
 ...
 public List<Map<String,String>> queryForListStr(String sql,List<Object[]> paramList,String conPoolName){
 	Connection conn = null;
     PreparedStatement pstmt = null;
     ResultSet rs = null;
 ...
 /**
	 ...
	 * @return
	 */
	public int queryForInt(String sql,List<Object[]> paramList,String conPoolName){
		Connection conn = null;
     PreparedStatement pstmt = null;
     ResultSet rs = null;
     int count=0;
	 ...
	 * @return
	 */
	public long queryForLong(String sql,List<Object[]> paramList,String conPoolName){
		Connection conn = null;
     PreparedStatement pstmt = null;
     ResultSet rs = null;
     long numberValue=0;
...
//    }
	 ...
	 * @return
	 */
//	public String queryForString(String sql,List<Object[]> paramList){
//		Connection conn = null;
//        PreparedStatement pstmt = null;
//        ResultSet rs = null;
//        String strVal=null;
...
//    }
	 ...
	 * @return
	 */
//	public long queryForLong2(String sql,List<Object[]> paramList){
//		Connection conn = null;
//        PreparedStatement pstmt = null;
//        ResultSet rs = null;
