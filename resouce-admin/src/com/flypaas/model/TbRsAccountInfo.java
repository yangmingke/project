...
public class TbRsAccountInfo {
    ...
    public void setIsPublicNet(String isPublicNet) {
        this.isPublicNet = isPublicNet == null ? null : isPublicNet.trim();
    }

    public String getIsPrivateNet() {
        return isPrivateNet;
    }

    public void setIsPrivateNet(String isPrivateNet) {
        this.isPrivateNet = isPrivateNet == null ? null : isPrivateNet.trim();
    }
