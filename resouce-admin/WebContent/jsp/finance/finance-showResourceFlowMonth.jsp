...
<form method="post" action="">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 节点流量月消耗</strong></div>
    <div class="padding border-bottom">
	    <ul class="search">
        	...
        	<li>
	     	 	<input type="text"  placeholder="请选择月份" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM',maxDate:'%y-%M'})" id="dateTime" value="${dateTime }" class="input-text Wdate" style="width:150px; height:38px; display:inline-block"  name="dateTime">
		  		&nbsp;&nbsp;&nbsp;&nbsp;
        	</li>
	      	<li>
...
function jumpTo(page){
	...
	$('body').load('/resourceFlowController/queryResourceFlowMonth',{"page":page,"keyWord":keyWord,"dateTime":dateTime,"monthTime":monthTime,"pageRowCount":pageRowCount});
}
