...
<form method="post" action="">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 资源方流量月消耗</strong></div>
    <div class="padding border-bottom">
	    <ul class="search">
        	...
        	<li>
	     	 	<input type="text"  placeholder="请选择月份" onfocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyyMM',maxDate:'%y-%M'})" id="dateTime" value="${dateTime }" class="input-text Wdate" style="width:150px; height:38px; display:inline-block"  name="dateTime">
		  		&nbsp;&nbsp;&nbsp;&nbsp;
        	</li>
	      	<li>
    ...
    <table class="table table-hover text-center" >
      ...
      <tr>
       ...
       <%-- <tr class="text-c">
        <td align="left"><label style="font-weight: bold;">统计汇总>></label></td>
        <td ><label style="font-weight: bold;">总入流量</label> : ${obj.totalTrafficIn}(K)</td>
        <td ><label style="font-weight: bold;">总出流量</label> : ${obj.totalTrafficOut}(K)</td>
        <td ><label style="font-weight: bold;">总流量</label> : ${obj.totalTraffic}(K)</td>
        <td ><label style="font-weight: bold;">平均价格</label> : ${obj.avgPrice}(分/K)</td>
        <td ><label style="font-weight: bold;">总收入</label> : ${obj.totalFee}(元)</td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
...
function jumpTo(page){
	...
	$('body').load('/resourceSideFlowController/queryResourceSideFlowMonth',{"page":page,"keyWord":keyWord,"dateTime":dateTime,"monthTime":monthTime,"pageRowCount":pageRowCount});
}
