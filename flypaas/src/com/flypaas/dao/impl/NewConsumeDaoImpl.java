...
@Repository
public class NewConsumeDaoImpl extends CdrMyBatisDao implements NewConsumeDao {
	@Autowired
...
//	private static final String GETYSTCSM="getYstCsm";
	private static final String GETYSTCSMNEW="getYstCsmNew";
...
//			result.setParams(myBatisDao.getOneInfo(sqlMapKey + "Total", params));
	...
	public Map<String, Object> getYstCsm(Map<String, String> map) {
		return sqlSessionTemplate.selectOne(GETYSTCSMNEW, map);
	}
