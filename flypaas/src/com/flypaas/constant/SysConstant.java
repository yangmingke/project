...
public class SysConstant {
	...
	//产品描述
	public static final String PRODUCT_DESC="flypaas developer platform recharge";
...
//图片类型
	...
	//App认证文件类型
	public static final String [] APP_FILE_TYPE_LIST = {"pem", "p12"};
//短信模板签名符合
...
//系统图片大小
	...
	//APP认证文件大小
	public static final long VALID_FILE_MAXSIZE=1*1024*1024;
//系统图片大小
...
//系统分隔符	
    ...
    static{
    	LOCAL_HOST = SysConfig.getInstance().getProperty("host");
    	PAY_GATEWAY_URL = SysConfig.getInstance().getProperty("host")+ SysConfig.getInstance().getProperty("pay_gateway_url");
    	PAY_GATEWAY_KEY = SysConfig.getInstance().getProperty("pay_gateway_key");
    	PAY_CALLBACK_URL =SysConfig.getInstance().getProperty("host")+ SysConfig.getInstance().getProperty("pay_callback_url");
