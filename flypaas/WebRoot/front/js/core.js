...
function core (pn,loop){
	...
	var slogan5 = $('#slogan_5');
	var slogan6 = $('#slogan_6');
	var slogan7 = $('#slogan_7');
	var slogan8 = $('#slogan_8');
	var slogan9 = $('#slogan_9');
	var slogan10 = $('#slogan_10');
	var slogan11 = $('#slogan_11');
	var slogan12 = $('#slogan_12');
	var slogan13 = $('#slogan_13');
	var p0btn = $('#p0_btn');
	...
	if (pn == 0) {
		...
		slogan3.velocity({rotateY:'20deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:0});
		slogan4.velocity({rotateY:'15deg',translateZ:'1900px',rotateX:'90deg',opacity:0},{duration:0});
		slogan5.velocity({rotateY:'10deg',translateZ:'2200px',rotateX:'90deg',opacity:0},{duration:0});
		slogan6.velocity({rotateY:'5deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan7.velocity({rotateY:'10deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan8.velocity({rotateY:'15deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan9.velocity({rotateY:'20deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan10.velocity({rotateY:'25deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan11.velocity({rotateY:'30deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan12.velocity({rotateY:'35deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		slogan13.velocity({rotateY:'40deg',translateZ:'1300px',rotateX:'90deg',opacity:0},{duration:0});
		// p0 in
		...
		slogan5.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan6.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan7.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan8.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan9.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan10.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan11.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan12.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		slogan13.velocity({rotateY:'0deg',translateZ:'0px',rotateX:'0deg',opacity:1},{duration:pub_t*2.4});
		...
		// p0 away
		var p0away = function () {
			slogan1.velocity({rotateY:'-10deg',translateZ:'1000px',rotateX:'30deg',opacity:0},{duration:pub_t*0.7});
			slogan2.velocity({rotateY:'-5deg',translateZ:'1300px',rotateX:'60deg',opacity:0},{duration:pub_t*1});
			slogan3.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan4.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan5.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan6.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan7.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan8.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan9.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan10.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan11.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan12.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
			slogan13.velocity({rotateY:'0deg',translateZ:'1600px',rotateX:'90deg',opacity:0},{duration:pub_t*1.3});
