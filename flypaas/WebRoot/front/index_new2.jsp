...
<body id="b-01">
	...
	<div id="item-05" class="sdk">
		...
		<div class="sdk_download">
			...
			<!-- <h3><a href="https://github.com/" target=_blank>SDK下载</a></h3> -->
		</div>
	</div>
	<div id="item-06" class="call_us">
		<div class="company">
			...
			<div class="company_img">
				...
				<%-- <ul>
					<li><img src="<%=path%>/front/images1/logo17.png" /></li> 
					<li><img src="<%=path%>/front/images1/logo18.png" /></li>
					<li><img src="<%=path%>/front/images1/logo19.png" /></li>
				</ul>
				<ul>
					<li><img src="<%=path%>/front/images1/logo20.png" /></li>
					<li><img src="<%=path%>/front/images1/logo21.png" /></li>
					<li><img src="<%=path%>/front/images1/logo22.png" /></li>
				</ul> --%>
			</div>
		</div>
		<div class="blog">
