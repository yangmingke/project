...
<body id="b-01">
	...
	<div id="banner" class="banner">
		<div class="banner_first">
			<h1><span class="gold_word">精</span>于技术</h1>
	...
	<div id="item-02" class="video_radio">
	...
	<div id="item-04" class="solution">
		...
		<div class="solution_introduce1">
			<h3 class="solution_introduce1_title">视频直播</h3>
			<h3>主播上行加速: 聚合海量网络节点后，可使得边缘接入节点离主播更近；通讯组网为上行提供了智能选路算法、最优动态路由选择，可保证上行连接稳定、延迟低</h3>
		</div>
		<div class="solution_introduce2">
			<h3 class="solution_introduce2_title">视频监控</h3>
			<h3>手机实时查看ipCam加速，通过就近接入和动态路由技术，可实现RTSP数据的加速推送</h3>
		</div>
		<div class="solution_introduce3">
			<h3 class="solution_introduce3_title">音视频聊天加速</h3>
			<h3>自研全部核心算法，在WebRTC的媒体处理框架之上，实现了端到端全面QoS优化</h3>
		</div>
		<div class="solution_introduce4">
			<h3 class="solution_introduce4_title">其他互联网通讯需求</h3>
			<h3>行业应用通讯加速：视频会议、在线教育、智慧社区、车联网和物联网应用中，通过动态路由技术，可实现数据源节点和分发末端节点之间数据的加速推送</h3>
		</div>
	</div>
	...
	<div id="item-06" class="call_us">
		<div>
			<div class="company">
				...
				<div class="company_img">
					<ul>
						...
						<li><img src="<%=path%>/front/images1/logo4.png" /></li>
			...
			<div class="blog">
	            <img src="<%=path%>/front/images1/sina_code.png" />
				<span><a href="http://weibo.com/u/6069886407">快传微博</a></span>
			</div>
		</div>
		<div class="head">
			<h1>联系我们</h1>
	...
	<div class="copyright">
        <div class="ft_footer_wp">
            <p>
            © 深圳市快传技术有限公司. All Rights Reserved<i class="space">|</i>服务协议<i class="space">|</i>隐私声明<i class="space">|</i><span class="icp">粤ICP备16104934号</span> 
            </p>
        </div>
    </div>
</body>
