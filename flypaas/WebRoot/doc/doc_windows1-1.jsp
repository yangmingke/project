...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li  class="active">
        	...
        	<dl>
        		...
        		<dd><a href="<%=path%>/doc/doc_windows1-1.jsp" class="active">Windows SDK介绍</a></dd>
        		<dd class="parent">
        			<a href="#"><em>初始化及配置接口</em></a>
        			<dl class="child">
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_windows5-1.jsp">Windows SDK</a> > <span>Windows SDK介绍</span></p></div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">Windows SDK介绍</span></h1>
      </div>
      <div class="display_ctn">
        <p>快传融合通讯开放平台Windows SDK是以C++动态库的方式提供给Windows开发人员，可以方便快速为您的Windows应用实现打电话和接听电话的功能，包括在游戏中实现实时语音聊天等功能。</p>
        <p>下载Windows版开发包：<br />UCS_SDK_Windows<a href="<%=path %>/product_service/download" >Download.zip</a></p>
        <h3 id="tgw1.1.1">1. SDK 文件介绍</h3>
        <p><span class="key_label">UCSClient.h</span>接口函数声明文件。 包含初始化、连接服务器、呼叫、应答、挂机、注销、回调函数、双向回拨、即时消息等能力接口函数。</p>
      </div>
    </div>
  </div>
  <div class="clear"></div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgw1.1.1">1. SDK 文件介绍</a></li>
    </ul>
  </div>
</div>
