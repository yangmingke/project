...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        ...
        <li>
         ...
         <li class="active">
        	...
        	<dl>
				...
				<dd><a href="<%=path%>/doc/doc_ios6-1.jsp" class="active">视频通话能力接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_ios5-1.jsp">iOS SDK</a> > <span>视频通话能力接口</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">视频通话能力接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgi6.1.1">1. 设置视频信息</h3>
        <pre>
          <code>
/**
 * 设置视频显示参数
 ...
 */
<span class="key_label">- (BOOL)setVideoConfig:(UIImageView*)localVideoView withRemoteVideoView:(UIImageView*)remoteView showtoRemoteVideoWidth:(int)width showtoRemoteVideoHeight:(int) height;</span></code>
        </pre>
        <h3 id="tgi6.1.2">2. 获取摄像头个数</h3>
        <pre>
          <code>
/**
 * 获取摄像头个数
 * @return int
 */
<span class="key_label">- (int) getCameraNum;</span></code>
        </pre>
        <h3 id="tgi6.1.3">3. 切换摄像头</h3>
        <pre>
          <code>
/**
 * 摄像头切换
 ...
 * @return BOOL  YES：成功；NO：失败  
 */
<span class="key_label">- (BOOL) switchCameraDevice:(int)CameraIndex;</span></code>
        </pre>
        <h3 id="tgi6.1.4">4. 开启视频预览</h3>
        <pre>
          <code>
/**
 * @param CameraIndex 摄像头位置 
 * @return BOOL  YES：成功；NO：失败
 */
<span class="key_label">- (BOOL) openCamera:(int)CameraIndex;</span></code>
        </pre>
        <h3 id="tgi6.1.5">5. 关闭视频预览</h3>
        <pre>
          <code>
/**
 * @param CameraIndex 摄像头位置 
 * @return BOOL  YES：成功；NO：失败
 */
<span class="key_label">- (BOOL)closeCamera:(int)CameraIndex;</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgi6.1.1">1. 设置视频信息</a></li>
	  <li><a href="#tgi6.1.2">2. 获取摄像头个数</a></li>
	  <li><a href="#tgi6.1.3">3. 切换摄像头</a></li>
	  <li><a href="#tgi6.1.4">4. 开启视频预览</a></li>
	  <li><a href="#tgi6.1.5">5. 关闭视频预览</a></li>
    </ul>
  </div>
</div>
