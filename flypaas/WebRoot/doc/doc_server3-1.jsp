...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li  class="active">
        	...
        	<dl style="display:block;">
        		...
        		<dd><a href="<%=path%>/doc/doc_server3-1.jsp" class="active">呼叫鉴权请求接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_server6-1.jsp">应用服务器接口</a> > <span>呼叫鉴权请求接口</span></p>
      </div>
      <div class="display_tit">
        <h1><span class="intro">呼叫鉴权请求接口</span></h1>
      </div>
      <div class="display_ctn">
        <b>• 关系拓扑</b>
        <p><img src="<%=path %><%=path%>/doc/images/doc_img2.png"></p>
        <h3 id="tgs3.1.1">1.1 呼叫鉴权请求接口</h3>
        <b id="tgs3.1.1.1">• 请求地址</b>
        <p>需要第三方自行配置URL地址。</p>
        <b id="tgs3.1.1.2">• 请求包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            ...
            <tr>
              <td class="red">event</td>
              <td class="red">String</td>
              <td class="red">必选</td>
              <td><span class="red">值为：callreq</span></td>
            </tr>
            <tr>
              <td>callid</td>
              <td>String</td>
              <td>必选</td>
              <td><span>呼叫的唯一标识（sdk组件生成）</span></td>
            </tr>
            <tr>
              <td>accountid</td>
              <td>String</td>
            ...
            <tr>
              <td>callerchargetype</td>
              <td>int</td>
              <td>必选</td>
              <td><span>主叫计费类型，0：开发者计费1：PAAS平台计费，默认为0 </span></td>
            </tr>
            <tr>
              <td>callerbalance</td>
              <td>float</td>
              <td>必选</td>
              <td><span>在PAAS平台主叫帐户钱包余额(单位:元)</span></td>
            </tr>
            <tr>
              <td>caller</td>
              <td>String</td>
...
&lt;/request&gt;</code>
        ...
        <h3 id="tgs3.1.2">1.2 第三方AS响应</h3>
        <b id="tgs3.1.2.1">响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
            ...
            <tr>
              ...
              <td class="red">int</td>
              <td class="red">必选</td>
              <td><span class="red">返回错误码，0：成功，非0：失败;</span><span> 注：该错误码支持开发者自定义错误码，并且透传至应用层，方便AS与客户端之间的通讯。</span><span>开发者自定义错误码的规则是：int类型：10000~20000范围之间。</span></td>
            </tr>
            <tr>
              <td>reason</td>
              <td>string</td>
              <td>可选</td>
              <td><span>原因描述，可以支持中文描述</span></td>
            </tr>
            <tr>
              <td>record</td>
              <td>String</td>
              <td>可选</td>
              <td><span>是否录音；0：不录音；1：录音；默认为0。</span></td>
            </tr>
            <tr>
              <td>displaynumber</td>
              <td>string</td>
              <td>可选</td>
              <td><span>被叫显号号码，具体显号规则请查看<a href="http://docs.flypaas.com/doku.php?=显号规则说明" style="text-decoration:none;">《显号规则说明》</a></span></td>
            </tr>
            <tr>
              <td class="red">allowedcalltime</td>
              <td class="red">string</td>
              <td>可选</td>
              <td><span class="red">允许通话时长单位为秒（值必须为60的倍数，如60s、120s、180s），若需控制当前通话时长，allowedcalltime传入的值必须大于或等于0，平台将按此值控制当前通话时长；当allowedcalltime传入的值小于0时，平台默认不限制当前通话时长。</span></td>
            </tr>
          </tbody>
        </table>
        <b id="tgs3.1.2.2">• XML响应示例</b>
        <pre>
          <code class="code_fn">
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgs3.1.1">1. 呼叫鉴权请求接口</a>
      <ul>
        <li><a href="#tgs3.1.1.1">1.1 请求地址</a></li>
		<li><a href="#tgs3.1.1.2">1.2 请求包体</a></li>
        <li><a href="#tgs3.1.1.3">1.3  XML请求示例</a></li>
      </ul>
      </li>
	  <li><a href="#tgs3.1.2">2. 第三方AS响应</a>
      <ul>
        <li><a href="#tgs3.1.2.1">2.1 响应包体</a></li>
		<li><a href="#tgs3.1.2.2">2.2 XML响应示例</a></li>
      </ul>
      </li>
    </ul>
  </div>
