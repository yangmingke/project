...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li class="active">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			<a href="javascript:void(0)" class="active"><em>呼叫</em></a>
        			<dl class="child" style="display:block;">
        				<dd><a href="<%=path%>/doc/doc_rest3-1.jsp" class="active">双向回拨</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_rest1-1.jsp">REST API</a> > <a href="<%=path%>/doc/doc_rest3-1.jsp">呼叫</a> > <span>双向回拨</span></p>
      </div>
      <div class="display_tit">
        <h1><span class="intro">双向回拨</span></h1>
      </div>
      <div class="display_ctn">
        <p>请通过HTTPS POST方式提交请求，快传融合通讯开放平台收到请求后，将向两个电话终端发起呼叫，双方接通电话后进行通话。</p>
        <h3 id="tgr3.1.1">1.1 请求</h3>
        <b id="tgr3.1.1.1">• 请求地址</b>
        <p class="code"><span>/{SoftVersion}/Accounts/{AccountSid}/Calls/callBack</span></p>
        <b id="tgr3.1.1.2">• 请求包头</b>
        <p><span>详情请查阅统一请求包头，并使用开发者账号进行验证。</span></p>
        <b id="tgr3.1.1.3">• 请求包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            ...
            <tr>
              ...
              <td>String</td>
              <td>必选</td>
              <td><span>主叫ClientNumber号码，ClientNumber必须是绑定了主叫正常的电话号码。</span></td>
            </tr>
            <tr>
              <td>to</td>
              <td>String</td>
              <td>必选</td>
              <td><span>被叫正常电话号码。</span></td>
            </tr>
			<tr>
              <td>fromSerNum</td>
              <td>String</td>
              <td>可选</td>
              <td><span>主叫侧显示的号码，只能显示400号码或固话。查阅<a href="http://docs.flypaas.com/doku.php?=显号规则说明" style="text-decoration:none;">显号规则</a>。</span></td>
            </tr>
			<tr>
              <td>toSerNum</td>
              <td>String</td>
              <td>可选</td>
              <td><span>被叫侧显示的号码。可显示手机号码、400号码或固话。查阅<a href="http://docs.flypaas.com/doku.php?=显号规则说明" style="text-decoration:none;">显号规则</a>。</span></td>
            </tr>
      <tr>
              <td>maxallowtime</td>
              <td>String</td>
              <td>可选</td>
              <td><span>允许通话时长单位为秒（值必须为60的倍数，如60s、120s、180s）</span></td>
            </tr>
          </tbody>
        </table>
        <b id="tgr3.1.1.4">• XML请求示例</b>
        <pre>
          <code class="code_fn">
...
Authorization:ZTAzYmM5MTA2YzZlZDBlYWViZmNlOGMzNjhmZGNkNDg6MjAxNDA5MTgxNjQ4MTg=
{
 ...
 "maxallowtime"   : "910"
        ...
        <h3 id="tgr3.1.2">1.2 响应</h3>
        <b id="tgr3.1.2.1">• 响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgr3.1.1">1. 请求</a>
      <ul>
        <li><a href="#tgr3.1.1.1">1.1 请求地址</a></li>
		<li><a href="#tgr3.1.1.2">1.2 请求包头</a></li>
		<li><a href="#tgr3.1.1.3">1.3 请求包体</a></li>
		<li><a href="#tgr3.1.1.4">1.4 XML请求示例</a></li>
		<li><a href="#tgr3.1.1.5">1.5 JSON请求示例</a></li>        
      </ul>
      </li>
	  <li><a href="#tgr3.1.2">2. 响应</a>
      <ul>
        <li><a href="#tgr3.1.2.1">2.1 响应包体</a></li>
		<li><a href="#tgr3.1.2.2">2.2 XML响应示例</a></li>
		<li><a href="#tgr3.1.2.3">2.3 JSON响应示例</a></li>     
      </ul>
      </li>
    </ul>
  </div>
