...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li class="active">
        	...
        	<dl>
				...
				<dd><a href="<%=path%>/doc/doc_android8-1.jsp" class="active">用户在线查询能力接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_android6-1.jsp">Android SDK</a> > <span>用户在线查询能力接口</span></p></div>
      <div class="display_tit">
        <h1 style="width:280px;"><span class="intro">用户在线查询能力接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tga8.1.1">1. 查询多个client状态</h3>
        <pre>
          <code>
/**
 * 查询多个client状态
 * @param  Emun:查询类型    phone/clientId
 * @param clientList:要查询的号码列表
 * @return void  
 */
<span class="key_label">UCSMessage.queryUserState(ClientType,ArrayList&lt;String&gt; clientList);</span>
</code>
        </pre>
        <h3 id="tga8.1.2">2. 查询单个client状态</h3>
        <pre>
          <code>
/**
 * 查询单个client状态
 * @param  Emun:查询类型    phone/clientId
 * @param clientphone:要查询的手机号码或者clientId
 * @return void  
 */
<span class="key_label">UCSMessage.queryUserState(ClientType,String clientphone);</span>
</code>
        </pre>
        <h3 id="tga8.1.3">3. 查询状态回调</h3>
        <pre>
          <code>
/**
 * 查询状态回调
 * @param list 反回查询Client账号的列表
 * @return void
 */
<span class="key_label">onUserState(ArrayList&lt;UcsStatus&gt; list);</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tga8.1.1">1. 查询多个client状态</a></li>
      <li><a href="#tga8.1.2">2. 查询单个client状态</a></li>
      <li><a href="#tga8.1.3">3. 查询状态回调</a></li>
    </ul>
  </div>
</div>
