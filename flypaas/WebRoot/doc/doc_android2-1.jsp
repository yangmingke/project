...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li class="active">
        	...
        	<dl>
        		...
        		<dd><a href="<%=path%>/doc/doc_android2-1.jsp" class="active">初始化及配置接口</a></dd>
        		<dd class="parent">
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_android6-1.jsp">Android SDK</a> > <span>初始化及配置接口</span></p></div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">初始化及配置接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tga2.1.1">1. 初始化SDK</h3>
        <pre>
          <code>
/**
 * 初始化SDK
 * @param mContext  当前程序上下文 ApplicationContext
 * @param isSwitch  日志开关，true：打开；false：关闭
 * @return void
 * @初始化完成后会通过UCSService.ACTION_INIT_SUCCESS广播返回
 */
<span class="key_label">UCSService. init(Context mContext, boolean isSwitch);</span></code>
        </pre>
        <h3 id="tga2.1.2">2. 添加监听器</h3>
        <pre>
          <code>
/**
 * 添加监听器接口
 * @param connectionListener  监听器ConnectionListener的实例
 * @return void
 */
<span class="key_label">UCSService.addConnectionListener(ConnectionListener connectionListener)</span></code>
        </pre>        
        <h3 id="tga2.1.3">3. 连接云平台</h3>
        <pre>
          <code>
/**
 * 连接云平台
 ...
 * @return void
 */
<span class="key_label">UCSService.connect(String accountSid, String accountToken, String ClientNumber, String ClientPwd)</span></code>
        </pre>        
        <!--<h3 id="tga2.1.4">4. 连接云平台(自定义IP与端口)</h3>
        <pre>
          <code>
/**
 * 连接云平台
 ...
 * @return void
 */
<span class="key_label">UCSService.connect(String host,String port,String accountSid, String accountToken, String ClientNumber, String ClientPwd)</span></code>
        </pre>-->
        <h3 id="tga2.1.5">4. 连接云平台(token)</h3>
        <pre>
          <code>
/**
 * 连接云平台
 ...
 * @return void
 */
<span class="key_label">UCSService.connect(String token) </span></code>
        </pre>
        <!--<h3 id="tga2.1.6">6. 连接云平台(token 自定义IP与端口)</h3>
        <pre>
          <code>
/**
 * 连接云平台
 ...
 * @return void
 */
<span class="key_label">UCSService.connect(String host,String port,token)</span></code>
        </pre>-->
		<h3 id="tga2.1.7">5. 获取连接云平台状态</h3>
        <pre>
          <code>
/**
 * 获取连接云平台状态
 ...
 */
<span class="key_label">UCSService.isConnected()</span></code>
        </pre>
		<h3 id="tga2.1.8">6. 连接云平台回调</h3>
        <pre>
          <code>
/**
 * 连接云平台成功回调
 ...
 * @return void 
 */
<span class="key_label">onConnectionSuccessful()</span></code>
        </pre>
		<pre>
          <code>
/**
 ...
 * @return void 
 */
<span class="key_label">onConnectionFailed(UcsReason reason) </span></code>
        </pre>
		<h3 id="tga2.1.9">7. 断开云平台连接</h3>
        <pre>
          <code>
/**
 * 断开与云平台的连接
 ...
 * @return void 
 */
<span class="key_label">UCSService.uninit()</span></code>
        </pre>
		<h3 id="tga2.1.10">8. 获取SDK版本号</h3>
        <pre>
          <code>
/**
 * 获取SDK版本号
 * @return String 
 */
<span class="key_label">UCSService.getSDKVersion()</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tga2.1.1">1. 初始化SDK</a></li>
      <li><a href="#tga2.1.2">2. 添加监听器</a></li>
	  <li><a href="#tga2.1.3">3. 连接云平台</a></li>
      <!--<li><a href="#tga2.1.4">4. 连接云平台(自定义IP与端口)</a></li>-->
	  <li><a href="#tga2.1.5">4. 连接云平台(token)</a></li>
      <!--<li><a href="#tga2.1.6">6. 连接云平台(token 自定义IP与端口)</a></li>-->
	  <li><a href="#tga2.1.7">5. 获取连接云平台状态</a></li>
	  <li><a href="#tga2.1.8">6. 连接云平台回调</a></li>
      <li><a href="#tga2.1.9">7. 断开云平台连接</a></li>
	  <li><a href="#tga2.1.10">8. 获取SDK版本号</a></li>
    </ul>
  </div>
</div>
