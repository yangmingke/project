...
<title>如何转为PCM格式_快传融合通讯开放平台</title>
  ...
  <div class="display_wrapper">
    ...
    <div class="doc_txt doc_home">
      ...
      <div class="display_tit">
        <h1 style="width:400px;"><span class="intro">Android 将MP3制做成PCM铃声文件</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgpcm1.1.1">1. 下载Adobe Audition软件</h2>
		<h3 id="tgpcm1.1.2">2. 打开Audition  软件</h2>
		<h3 id="tgpcm1.1.3">3．文件>打开>选择mp3文件</h2>
        <p>如图所示：<br />
	<img src="<%=path%>/doc/images/doc_img67.png" width="100%" />
        </p>
        <h3 id="tgpcm1.1.4">4．用鼠标选择一段波形复制</h3>
        <p>如图所示：<br />
	<img src="<%=path%>/doc/images/doc_img68.png" width="100%" /></p>
	    <h3 id="tgpcm1.1.5">5．文件>新键>使用默认选项>确定</h3>
        <p>如图所示：<br />
	<img src="<%=path%>/doc/images/doc_img69.png" /></p>
	    <h3 id="tgpcm1.1.6">6．在黑底区域粘贴</h3>
        <p>如图所示：<br />
	<img src="<%=path%>/doc/images/doc_img70.png" /></p>
	    <h3 id="tgpcm1.1.7">7．保存</h3>
        <p>选择文件类型为 pcm raw <br />如图所示：<br />
	<img src="<%=path%>/doc/images/doc_img71.png" /></p>
	  </div>
    </div>
  </div>
  <div class="clear"></div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgpcm1.1.1">1. 下载Adobe Audition软件</a></li>
	  <li><a href="#tgpcm1.1.2">2. 打开Audition  软件</a></li>
	  <li><a href="#tgpcm1.1.3">3. 文件>打开>选择mp3文件</a></li>
      <li><a href="#tgpcm1.1.4">4. 用鼠标选择一段波形复制</a></li>
	  <li><a href="#tgpcm1.1.5">5. 文件>新键>使用默认选项>确定</a></li>
	  <li><a href="#tgpcm1.1.6">6. 在黑底区域粘贴</a></li>
	  <li><a href="#tgpcm1.1.7">7. 保存</a></li>
    </ul>
  </div>
</div>
