...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
   <div class="doc_menu">
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_android6-1.jsp">Android SDK</a> > <a href="<%=path%>/doc/doc_android4-1.jsp">IM接口</a> > <span>IM消息回调接口</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">IM消息回调接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tga4.2.1">1. 收到消息</h3>
        <pre>
          <code>
/**
 * 收到IM消息回调
 ...
 * @return void  
 */
<span class="key_label">onReceiveUcsMessage(UcsReason  reason ,  UcsMessage msg) </span></code>
        </pre>
        <h3 id="tga4.2.2">2. 发送IM消息回调</h3>
        <pre>
          <code>
/**
 ...
 * @return void  
 */
<span class="key_label">onSendUcsMessage(UcsReason reason , UcsMessage data)</span></code>
        </pre>
        <h3 id="tga4.2.3">3. 下载IM附件回调</h3>
        <pre>
          <code>
/**
 * 下载IM附件回调
 ...
 * @return void  
 */
<span class="key_label">onDownloadAttached(String msgId，String filePath，int size，int curProgress) </span></code>
        </pre>
        <h3 id="tga4.2.4">4. 发送附件进度回调</h3>
        <pre>
          <code>
/**
 * 发送附件进度回调
 ...
 * @return void
 */
<span class="key_label">onSendFileProgress(int progress)</span></code>
        </pre>
        <h3 id="tga4.2.5">5. 播放音频结束回调</h3>
        <pre>
          <code>
/**
 * 播放语音结束回调
 ...
 * @return void
 */
<span class="key_label">onFinishedPlayingVoice()</span></code>
        </pre>
        <h3 id="tga4.2.6">6. 停止录音回调</h3>
        <pre>
          <code>
/**
 * 停止录音回调
 ...
 * @return void
 */
<span class="key_label">onFinishedRecordingVoice (int  duration)</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tga4.2.1">1. 收到消息</a></li>
      <li><a href="#tga4.2.2">2. 发送IM消息回调</a></li>
	  <li><a href="#tga4.2.3">3. 下载IM附件回调</a></li>
      <li><a href="#tga4.2.4">4. 发送附件进度回调</a></li>
	  <li><a href="#tga4.2.5">5. 播放音频结束回调</a></li>
      <li><a href="#tga4.2.6">6. 停止录音回调</a></li>
    </ul>
  </div>
</div>
