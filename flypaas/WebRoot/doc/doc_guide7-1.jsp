...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        <li  class="active">
        	...
        	<dl>
                ...
                <dd><a href="<%=path%>/doc/doc_guide7-1.jsp" class="active">充值流程</a></dd>  
    ...
    <div class="doc_txt doc_guide">
      <div class="pathbox"><p><a href="<%=path%>/doc/doc.jsp">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_guide4-1.jsp">新手指引</a> > <span>充值流程</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">充值流程</span></h1>
      </div>
      <div class="display_ctn">	    
        <p><img src="<%=path%>/doc/images/doc_step3.png" class="step_img" /></p>
        <p>• 在快传融合通讯开放平台管理中心，点击“充值”或在“开发者信息”一栏中，点击“充值”即可进入账户充值页面。<br />
        <img src="<%=path%>/doc/images/doc_img51.png" width="100%" /></p>
        <p>• 在充值页面可看到有两种充值方式，一种是直接输入账户要充值的金额进行充值，另一种是选择活动兑换码进行充值。</p>
		<p>(1)输入账户要充值的金额（尽量保障账户余额大于账户内的套餐保底套餐额度）。<br />
        <img src="<%=path%>/doc/images/doc_img52.png" width="100%" /></p>
		<p>(2)选择兑换码充值。用户可输入活动获取的兑换码，进行账户充值，兑换码不同，充值金额不同。<br />
		输入兑换码后即可获得兑换的额度信息，点击下一步即充值成功。<br />
        <img src="<%=path%>/doc/images/doc_img72.png" width="100%" /></p>
        <p>• 输入金额后点击“下一步”进入订单确认页面，在确认完订单信息后，根据自身情况选择支付方式，并点击“确认支付”。<br />
        <img src="<%=path%>/doc/images/doc_img53.png" width="100%" /></p>
        <p>• 在第三方完成支付后，需要确认是否支付成功，可选择查看订单详情，或者选择其他支付方式进行支付。<br />
        <img src="<%=path%>/doc/images/doc_img54.png" width="100%" /></p>
     </div>
    </div>
  </div>
  <div class="clear"></div>
