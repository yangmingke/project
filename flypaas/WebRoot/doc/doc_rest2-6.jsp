...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd><a href="<%=path%>/doc/doc_rest2-6.jsp" class="active">应用详单下载</a></dd>
        				<!--<dd><a href="<%=path%>/doc/doc_rest2-7.jsp">Client详单下载</a></dd>-->
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_rest1-1.jsp">REST API</a> > <a href="<%=path%>/doc/doc_rest2-1.jsp">账户管理</a> > <span>应用详单下载</span></p>
      </div>
      <div class="display_tit">
        <h1><span class="intro">应用详单下载</span></h1>
      </div>
      <div class="display_ctn">
        <p>通过HTTPS POST方式提交请求，快传融合通讯开放平台收到请求后，返回应用详单下载地址及文件下载检验码。</p>
        <h3 id="tgr2.6.1">1.1 请求</h3>
        <b id="tgr2.6.1.1">• 请求地址</b>
        <p class="code"><span>/{SoftVersion}/Accounts/{accountSid}/billList</span></p>
        <b id="tgr2.6.1.2">• 请求包头</b>
        <p><span>详情请查阅统一请求包头，并使用开发者账号进行验证。</span></p>
        <b id="tgr2.6.1.3">• 请求包体</b>
        ...
        <b id="tgr2.6.1.4">• XML请求示例</b>
        <pre>
          <code class="code_fn">
POST/2014-06-30/Accounts/77df6f3a6d0c7b8e6b2946f48d2f72b0/billList.xml?sig=C17F25D970F28FEF32F689B842799644
Accept:application/xml
Content-Type:application/xml;charset=utf-8
Authorization:NzdkZjZmM2E2ZDBjN2I4ZTZiMjk0NmY0OGQyZjcyYjA6MjAxNDA2MjgxMTMzNTI=
...
&lt;/appBill&gt;</code>
        ...
        <b id="tgr2.6.1.5">• JSON请求示例</b>
        <pre>
          <code class="code_fn">
POST/2014-06-30/Accounts/77df6f3a6d0c7b8e6b2946f48d2f72b0/billList?sig=B669C48E06219144F639E620AA087C9C
Accept:application/json
Content-Type:application/json;charset=utf-8
Authorization:NzdkZjZmM2E2ZDBjN2I4ZTZiMjk0NmY0OGQyZjcyYjA6MjAxNDA2MjgxMTQ0NTY=

{
 "appBill" : {
    "appId"  : "0e0ad5c8ba5c4225b9eff2f4c0259196",
    "date"   : "day"
 }
}</code>
        </pre>
        <h3 id="tgr2.6.2">1.2 响应</h3>
        <b id="tgr2.6.2.1">• 响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
...
&lt;resp&gt;
    ...
    &lt;accountBill&gt;
        &lt;downUrl&gt;http://www.flypaas.com/fileserver/file?fileName=4aRWho%
2Bm8i0jCcNF0UCh5liqkdDUYwbFCZYolrIYX7RG%2FEWSZDWx1CW258AVvdBR%2
FPTj3p5Nv3y5%0AE8%2Bsmff8j0ltqFhrNgxlImRzJMk%2FlqLpFREnbxsDNg%3
D%3D&lt;/downUrl&gt;
        &lt;token&gt;4302d5deb51110ebe7e8522f5c59412c&lt;/token&gt;
    &lt;/accountBill&gt;
&lt;/resp&gt;</code>
        </pre>
        <b id="tgr2.6.2.3">• JSON响应示例</b>
        <pre>
          <code class="code_fn">
{
 "resp"   : {
    "respCode"   : "000000",
    "accountBill":{  
        "downUrl" :"http://www.flypaas.com/fileserver/file?fileName=4aRWho%2Bm8i0jCcNF0UCh5liqkdDUYwbFCZYolrIYX7RG%2FEWSZDWx1CW258AVvdBR%2FPTj3p5Nv3y5%0AE8%2Bsmff8j0ltqFhrNgxlImRzJMk%2FlqLpFREnbxsDNg%3D%3D",
        "token"   : "4302d5deb51110ebe7e8522f5c59412c"
        } 
    }
}</code>
        </pre>
        <h3 id="tgr2.6.3">1.3 通用详单下载URL</h3>
        <p>开发者使用响应回包中的开发者账号详单下载地址和文件下载检验码发起下载请求。</p>
        <p class="code"><span>GET {downUrl}&token={token}</span></p>
        <p>详单格式如下：</p>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgr2.6.1">1. 请求</a>
      <ul>
        <li><a href="#tgr2.6.1.1">1.1 请求地址</a></li>
		<li><a href="#tgr2.6.1.2">1.2 请求包头</a></li>
		<li><a href="#tgr2.6.1.3">1.3 请求包体</a></li>
		<li><a href="#tgr2.6.1.4">1.4 XML请求示例</a></li>
		<li><a href="#tgr2.6.1.5">1.5 JSON请求示例</a></li>        
      </ul>
      </li>
	  <li><a href="#tgr2.6.2">2. 响应</a>
      <ul>
        <li><a href="#tgr2.6.2.1">2.1 响应包体</a></li>
		<li><a href="#tgr2.6.2.2">2.2 XML响应示例</a></li>
		<li><a href="#tgr2.6.2.3">2.3 JSON响应示例</a></li>     
      </ul>
      </li>
	  <li><a href="#tgr2.6.3">3. 通用详单下载URL</a></li>
    </ul>
  </div>
</div>
