...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li class="active"><!--<span onclick="location.href='doc_errorcode1-1.html'" style="background:#fff; width:188px;">错误代码<i class="parent">&nbsp;</i></span>-->
        	...
        	<dl style="display:block;">
        		...
        		<dd><a href="doc_errorcode3-1.jsp" class="active">Windows错误码</a></dd>
    ...
    <div class="doc_txt">
	  <div class="pathbox"><p><a href="<%=path%>/doc/doc.jsp">帮助文档首页</a> > <a href="<%=path%>/doc/doc_errorcode1-1.jsp">错误代码</a> > <span>Windows错误码</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">Windows错误码</span></h1>
      </div>
      <div class="display_ctn">
        <h2>Windows错误码定义</h2>
        <h3 id="tge3.1.1">1. 连接错误</h3>
        <table cellpadding="0" cellspacing="0" border="0" width="100%"  class="code_table">
            <tbody>
                ...
                <tr>
                    <td><span>201301</span></td><td><span>开发者账号或者密码为非法，空或者长度错误</span></td>
                </tr>
                <tr>
                    <td><span>201302</span></td><td><span>用户名或者密码错误</span></td>
                </tr>
                <tr>
                    <td><span>201303</span></td><td><span>Client用户不存在</span></td>
                </tr>
                <tr>
                    <td><span>201304</span></td><td><span>Client状态非法(Client状态为0 关闭状态)</span></td>
                </tr>
                <tr>
                    <td><span>201305</span></td><td><span>登录被拒绝（开发者账号状态关闭）</span></td>
                </tr>
                <tr>
                    <td><span>201306</span></td><td><span>密文登录时Token错误</span></td>
                </tr>
                <tr>
                    <td><span>201307</span></td><td><span>用户登录冲突</span></td>
                </tr>
                <tr>
                    <td><span>201308</span></td><td><span>登录异常失败，需要重新登录</span></td>
                </tr>
                <tr>
                    <td><span>201309</span></td><td><span>服务器强制下线</span></td>
                </tr>
            </tbody>
        </table>
        <h3 id="tge3.1.2">2. 呼叫错误</h3>
        <table cellpadding="0" cellspacing="0" border="0" width="100%"  class="code_table">
            <tbody>
                <tr>
                    <th><span>错误码</span></th><th><span>说明</span></th>
                ...
                <tr>
                    <td><span>202301</span></td><td><span>余额不足</span></td>
                </tr>
                <tr>
                    <td><span>202302</span></td><td><span>被叫忙</span></td>
                </tr>
                <tr>
                    <td><span>202303</span></td><td><span>被叫号码不存在或不在线</span></td>
                </tr>
                <tr>
                    <td><span>202304</span></td><td><span>号码错误</span></td>
                </tr>
                <tr>
                    <td><span>202305</span></td><td><span>被叫超时不应答</span></td>
                </tr>
                <tr>
                    <td><span>202306</span></td><td><span>被叫接听超时</span></td>
                </tr>
                <tr>
                    <td><span>202307</span></td><td><span>禁止呼叫</span></td>
                </tr>
                <tr>
                    <td><span>202308</span></td><td><span>账户冻结</span></td>
                </tr>
                <tr>
                    <td><span>202311</span></td><td><span>主叫挂断</span></td>
                </tr>
                <tr>
                    <td><span>202312</span></td><td><span>被叫拒接</span></td>
                </tr>
                <tr>
                    <td><span>202313</span></td><td><span>被叫挂断</span></td>
                </tr>
                <tr>
                    <td><span>202314</span></td><td><span>余额不足挂断</span></td>
                </tr>
            </tbody>
        </table>
        <h3 id="tge3.1.3">3. IM错误</h3>
        <table cellpadding="0" cellspacing="0" border="0" width="100%"  class="code_table">
            <tbody>
                <tr>
                    <th><span>错误码</span></th><th><span>说明</span></th>
                ...
                <tr>
                    <td><span>203301</span></td><td><span>上传失败</span></td>
                </tr>
                <tr>
                    <td><span>203302</span></td><td><span>下载失败</span></td>
                </tr>
            </tbody>
        </table>
        <h3 id="tge3.1.4">4. 平台服务器错误</h3>
        <table cellpadding="0" cellspacing="0" border="0" width="100%"  class="code_table">
            <tbody>
                <tr>
                    <th><span>错误码</span></th><th><span>说明</span></th>
                ...
                <tr>
                    <td><span>201501~201599</span></td><td><span>平台服务器内部错误</span></td>
                </tr>
            </tbody>
        </table>
      </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
      <ul>
        <li><a href="#tge3.1.1">1. 连接错误</a></li>
        <li><a href="#tge3.1.2">2. 呼叫错误</a></li>
		<li><a href="#tge3.1.3">3. IM错误</a></li>
		<li><a href="#tge3.1.4">4. 平台服务器错误</a></li>
      </ul>
  </div>
</div>
