...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd><a href="<%=path%>/doc/doc_rest2-3.jsp" class="active">释放Client账号</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_rest1-1.jsp">REST API</a> > <a href="<%=path%>/doc/doc_rest2-1.jsp">账户管理</a> > <span>释放Client账号</span></p>
      </div>
      <div class="display_tit">
        <h1><span class="intro">释放Client账号</span></h1>
      </div>
      <div class="display_ctn">
        <p>通过HTTPS POST方式提交请求，快传融合通讯开放平台收到请求后，返回释放Client的结果。</p>
        <h3 id="tgr2.3.1">1.1 请求</h3>
        <b id="tgr2.3.1.1">• 请求地址</b>
        <p class="code"><span>/{SoftVersion}/Accounts/{accountSid}/dropClient</span></p>
        <b id="tgr2.3.1.2">• 请求包头</b>
        <p><span>详情请查阅统一请求包头，并使用开发者账号进行验证。</span></p>
        <b id="tgr2.3.1.3">• 请求包体</b>
...

{
 "client"   : {
    ...
    "appId"        : "e462aba25bc6498fa5ada7eefe1401b7"
        ...
        <h3 id="tgr2.3.2">1.2 响应</h3>
        <b id="tgr2.3.2.1">• 响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgr2.3.1">1. 请求</a>
      <ul>
        <li><a href="#tgr2.3.1.1">1.1 请求地址</a></li>
		<li><a href="#tgr2.3.1.2">1.2 请求包头</a></li>
		<li><a href="#tgr2.3.1.3">1.3 请求包体</a></li>
		<li><a href="#tgr2.3.1.4">1.4 XML请求示例</a></li>
		<li><a href="#tgr2.3.1.5">1.5 JSON请求示例</a></li>        
      </ul>
      </li>
	  <li><a href="#tgr2.3.2">2. 响应</a>
      <ul>
        <li><a href="#tgr2.3.2.1">2.1 响应包体</a></li>
		<li><a href="#tgr2.3.2.2">2.2 XML响应示例</a></li>
		<li><a href="#tgr2.3.2.3">2.3 JSON响应示例</a></li>     
      </ul>
      </li>
    </ul>
  </div>
