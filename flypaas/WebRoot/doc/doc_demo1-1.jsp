...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
      ...
      <div class="menu_tit">
       ...
       <ul>
        ...
        <li>
         ...
         <!--<li><span onclick="location.href='<%=path%>/doc/doc_demo1-1.jsp'" style="background:#fff; width:203px;">DEMO<i class="parent" style="margin-right:26px;">&nbsp;</i></span></li>-->
    ...
    <div class="doc_txt doc_home">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <span>DEMO</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">DEMO</span></h1>
      </div>
      <div class="display_ctn">
        <p>快传融合通讯开放平台为开发者提供多语言Demo，让您可以轻松地选择你熟悉的编程语言来体验。以下是官方提供的Demo，这些Demo都是开源的，如果你发现错误，我们欢迎你的反馈，同时我们也鼓励开发者提供基于快传融合通讯开放平台SDK的项目。</p>
        <h3>演示DEMO</h3>
		<div class="develop_demo">
		<b>Android</b>
		<p>1. 手动点击下载<br />
		UCS_DEMO_Android <a href="http://www.flypaas.com/demo/UCSVoipDemo.apk">Download.zip</a></p>
		<p>2. 扫描二维码下载<br />
		<img src="<%=path%>/doc/images/android_demo_code.png" /></p>
		</div>
		<div class="develop_demo">
		<b>Windows</b>
		<p>1. 手动点击下载<br />
		UCS_DEMO_Windows <a href="http://www.flypaas.com/demo/UCS_DEMO_Windows.rar">Download.zip</a></p>
		</div>
		<div class="clear"></div>
		<h3>开发DEMO</h3>
		<b>iOS</b>
		<p>1. 手动点击下载<br />
		UCS_DEMO_iOS <a href="http://www.flypaas.com/demo/UCS_DEMO_iOS.rar">Download.zip</a></p>
		<p>2. 扫描二维码下载<br />
		<img src="<%=path%>/doc/images/ios_demo_code.png" /></p>
		<h3>REST DEMO</h3>
		<b>PHP</b>
		<p>UCS_REST_DEMO_Php <a href="<%=path %>/product_service/download">Download.zip</a></p>
		<b>JAVA</b>
		<p>UCS_REST_DEMO_Java <a href="<%=path %>/product_service/download">Download.zip</a></p>
		<b>PYTHON</b>
		<p>UCS_REST_DEMO_Python <a href="<%=path %>/product_service/download">Download.zip</a></p>
      </div>
    </div>
  </div>
  <div class="clear"></div>
