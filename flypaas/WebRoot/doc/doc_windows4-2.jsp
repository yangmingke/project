...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd class="last"><a href="<%=path%>/doc/doc_windows4-2.jsp" class="active">IM能力回调函数</a></dd>
        			</dl>
        		</dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_windows5-1.jsp">Windows SDK</a> > <a href="<%=path%>/doc/doc_windows4-1.jsp">IM接口</a> > <span>IM能力回调函数</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">IM回调函数</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgw4.2.1">1. 收到新的IM消息</h3>
        <pre>
          <code>
/*
  函数名   : onReceiveIMessage
  功能     : 收到新的IM消息回调
  参数     : [OUT]  data  : 消息UCS_INSTANTMESSAGE结构体
  返回值   : 无
*/
<span class="key_label">void (*onReceiveIMessage)(UCS_INSTANTMESSAGE *data); </span></code>
        </pre>
        <h3 id="tgw4.2.2">2. 发送即时消息回调</h3>
        <pre>
          <code>
/*
  函数名   : onSendIMessage
  ...
  返回值   : 无
*/
<span class="key_label">void (*onSendIMessage)(int reason, UCS_INSTANTMESSAGE *data); </span></code>
        </pre>
        <h3 id="tgw4.2.3">3. 下载附件回调</h3>
        <pre>
          <code>
/*
  函数名   : onDownloadFile
  功能     :下载附件回调
  参数     : [OUT]  data  : 下载结构体UCS_DOWNLOADINFO首指针
             [OUT]  reason : 状态值
  返回值   : 无
*/
<span class="key_label">void (*onDownloadFile)(int reason, UCS_DOWNLOADINFO *data);</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgw4.2.1">1. 收到新的IM消息</a></li>
	  <li><a href="#tgw4.2.2">2. 发送即时消息回调</a></li>
	  <li><a href="#tgw4.2.3">3. 下载附件回调</a></li>
    </ul>
  </div>
</div>
