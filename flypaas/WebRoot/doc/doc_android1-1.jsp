...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li class="active">
        	...
        	<dl>
        		...
        		<dd><a href="<%=path%>/doc/doc_android1-1.jsp" class="active">Android SDK介绍</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_android6-1.jsp">Android SDK</a> > <span>Android SDK介绍</span></p></div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">Android SDK介绍</span></h1>
      </div>
      <div class="display_ctn">
        ...
        <p>下载Android版开发包：<br />UCS_SDK_Android<a href="<%=path %>/product_service/download">Download.zip</a></p>
        <h3 id="tga1.1.1">1. SDK 通讯类介绍</h3>
        <p><span class="key_label">UCSService SDK</span>核心通讯类,用于连接云服务平台。</p>
        <p><span class="key_label">UCSMessage SDK</span>消息管理类,用于消息发送/录音,添加自定义消息类型等操作。</p>
        <p><span class="key_label">UCSCall SDK VoIP</span>电话管理类,用于呼叫请求,挂断,静音等一系统操作。</p>
        <h3 id="tga1.1.2">2. SDK 工具类介绍</h3>
        <p><span class="key_label">FileTools</span>文件工具类。</p>
        <p><span class="key_label">CustomLog</span>日志工具类，用于打印日志。</p>
        <p><span class="key_label">MapTools</span>地图位置工具类。</p>
      </div>
    </div>
  </div>
  <div class="clear"></div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tga1.1.1">1. SDK 通讯类介绍</a></li>
      <li><a href="#tga1.1.2">2. SDK 工具类介绍</a></li>
    </ul>
  </div>
</div>
