...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd><a href="<%=path%>/doc/doc_rest2-2.jsp" class="active">申请Client账号</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_rest1-1.jsp">REST API</a> > <a href="<%=path%>/doc/doc_rest2-1.jsp">账户管理</a> > <span>申请Client账号</span></p>
      </div>
      <div class="display_tit">
        <h1><span class="intro">申请Client账号</span></h1>
      </div>
      <div class="display_ctn">
        <p>通过HTTPS POST方式提交请求，快传融合通讯开放平台收到请求后，返回Client信息。</p>
        <h3 id="tgr2.2.1">1.1 请求</h3>
        <b id="tgr2.2.1.1">• 请求地址</b>
        <p class="code"><span>/{SoftVersion}/Accounts/{accountSid}/Clients</span></p>
        <b id="tgr2.2.1.2">• 请求包头</b>
        <p><span>详情请查阅统一请求包头，并使用开发者账号进行验证。</span></p>
        <b id="tgr2.2.1.3">• 请求包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            ...
            <tr>
              ...
              <td>String</td>
              <td>必选</td>
              <td><span>0  开发者计费；1 云平台计费。默认为0。</span></td>
            </tr>
            <tr>
              <td>charge</td>
              <td>String</td>
              <td>必选</td>
              <td><span>充值金额（开发者计费即ClientType为0时，为可选参数），默认为0。</span></td>
            </tr>
            <tr>
              <td>friendlyName</td>
              <td>String</td>
              <td>可选</td>
              <td><span>Client名称。可由英文字母和阿拉伯数字组成Client名称，同一个应用下唯一。</span></td>
            </tr>
            <tr>
              <td>mobile</td>
              <td>String</td>
              <td>可选</td>
              <td><span>绑定的手机号码。同一个应用内唯一。</span></td>
            </tr>
          </tbody>
        </table>
        <b id="tgr2.2.1.4">• XML请求示例</b>
        <pre>
          <code class="code_fn">
...
Authorization:ZTAzYmM5MTA2YzZlZDBlYWViZmNlOGMzNjhmZGNkNDg6MjAxNDA2MjMxNzE2MzI=</code>
        </pre>
        <pre>
          <code class="code_fn">
...

{
 "client"   : {
    ...
    "clientType"   : "1"
        ...
        <h3 id="tgr2.2.2">1.2 响应</h3>
        <b id="tgr2.2.2.1">• 响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
            ...
            <tr>
              <td class="red">clientNumber</td>
              <td class="red">String</td>
              <td class="red">必选</td>
              <td><span class="red">Client号码。由14位数字组成</span></td>
            </tr>
            <tr>
              <td class="red">clientPwd</td>
              <td class="red">String</td>
              <td class="red">必选</td>
              <td><span class="red">Client密码。由8位数字和字母组成</span></td>
            </tr>
            <tr>
              <td>createDate</td>
              <td>String</td>
            ...
            <tr>
              ...
              <td>String</td>
              <td>可选</td>
              <td><span>用户余额（云平台计费类型）</span></td>
            </tr>
          </tbody>
        </table>
        <b id="tgr2.2.2.2">• XML响应示例</b>
        <pre>
          <code class="code_fn">
&lt;?xml version="1.0" encoding="UTF-8" standalone="yes"?&gt;
&lt;resp&gt;
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgr2.2.1">1. 请求</a>
      <ul>
        <li><a href="#tgr2.2.1.1">1.1 请求地址</a></li>
		<li><a href="#tgr2.2.1.2">1.2 请求包头</a></li>
		<li><a href="#tgr2.2.1.3">1.3 请求包体</a></li>
		<li><a href="#tgr2.2.1.4">1.4 XML请求示例</a></li>
		<li><a href="#tgr2.2.1.5">1.5 JSON请求示例</a></li>        
      </ul>
      </li>
	  <li><a href="#tgr2.2.2">2. 响应</a>
      <ul>
        <li><a href="#tgr2.2.2.1">2.1 响应包体</a></li>
		<li><a href="#tgr2.2.2.2">2.2 XML响应示例</a></li>
		<li><a href="#tgr2.2.2.3">2.3 JSON响应示例</a></li>     
      </ul>
      </li>
    </ul>
  </div>
