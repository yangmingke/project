...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd class="last"><a href="<%=path%>/doc/doc_android3-2.jsp" class="active">VoIP状态回调接口</a></dd>
        			</dl>
        		</dd>
        		<dd class="parent">
        			<a href="#"><em>IM接口</em></a>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_android6-1.jsp">Android SDK</a> > <a href="<%=path%>/doc/doc_android3-1.jsp">VoIP接口</a> > <span>VoIP状态回调接口</span></p></div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">VoIP状态回调接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tga3.2.1">1. 呼叫失败</h3>
        <pre>
          <code>
/**
 * 呼叫失败回调
 ...
 * @return void
 */
<span class="key_label">onDialFailed (String callid，UcsReason reason)</span></code>
        </pre>
        <h3 id="tga3.2.2">2. 新电话呼入</h3>
        <pre>
          <code>
/**
 *来电回调函数
 * @param callId 返回当前会议id号
 * @param callType来电类型：0：Voip来电 2：会议来电
 * @param callerNumber 主叫号码
 * @param nickName显示主叫昵称(未使用时，可不关心)
 * @param userdata 用户透传数据(未使用时，可不关心)
 * @return void
 */
<span class="key_label">onIncomingCall(String callId, String callType, String callerNumber ,String nickName, String userdata)</</span></code>
        </pre>
        <h3 id="tga3.2.3">3. 呼叫被释放</h3>
        <pre>
          <code>
/**
 * 呼叫被释放回调
 ...
 * @return void
 */
<span class="key_label">onHangUp(String callid，UcsReason reason)</span></code>
        </pre>
        <h3 id="tga3.2.4">4. 呼叫振铃中</h3>
        <pre>
          <code>
/**
 * 呼叫振铃中回调
 ...
 * @return void
 */
<span class="key_label">onAlerting (String callid)</span></code>
        </pre>
        <h3 id="tga3.2.5">5. 被叫接听</h3>
        <pre>
          <code>
/**
 * 被叫接听回调
 ...
 * @return void
 */
<span class="key_label">onAnswer(String callid)</span></code>
        </pre>
        <h3 id="tga3.2.6">6. 回拨状态成功</h3>
        <pre>
          <code>
/**
 * 回拨状态成功
 ...
 * @return void
 */
<span class="key_label">onCallBackSuccess()</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tga3.2.1">1. 呼叫失败</a></li>
      <li><a href="#tga3.2.2">2. 新电话呼入</a></li>
	  <li><a href="#tga3.2.3">3. 呼叫被释放</a></li>
      <li><a href="#tga3.2.4">4. 呼叫振铃中</a></li>
	  <li><a href="#tga3.2.5">5. 被叫接听</a></li>
      <li><a href="#tga3.2.6">6. 回拨状态成功</a></li>
    </ul>
  </div>
</div>
