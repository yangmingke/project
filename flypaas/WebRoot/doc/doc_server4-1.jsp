  ...
  <div class="display_wrapper">
    <div class="doc_menu">
      ...
      <ul>
        ...
        <li> <span>REST API<i class="parent">&nbsp;</i></span>
          <dl style="display:none;">
            ...
            <dd class="parent"> <a href="javascript:void(0)"><em>呼叫</em></a>
              <dl class="child">
        ...
        <li  class="active">
        	...
        	<dl style="display:block;">
        		...
        		<dd><a href="<%=path%>/doc/doc_server4-1.jsp" class="active">呼叫建立通知接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_server6-1.jsp">应用服务器接口</a> > <span>呼叫建立通知接口</span></p>
      </div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">呼叫建立通知接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgs4.1.1">1.1 平台请求</h3>
        <b id="tgs4.1.1.1">• 请求地址</b>
        <p>需要第三方自行配置URL地址。</p>
        <b id="tgs4.1.1.2">• 请求包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            ...
            <tr>
              ...
              <td>String</td>
              <td>必选</td>
              <td><span>值为：callestablish</span></td>
            </tr>
            <tr>
              <td>callid</td>
              <td>string</td>
        ...
        <b id="tgs4.1.1.3">• XML请求示例</b>
        <pre>
          <code class="code_fn">
POST /coolweb/callest HTTP/1.1
...
&lt;/request&gt;</code>
        ...
        <h3 id="tgs4.1.2">1.2 第三方AS响应</h3>
        <b id="tgs4.1.2.1">响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgs4.1.1">1. 平台请求</a>
      <ul>
        <li><a href="#tgs4.1.1.1">1.1 请求地址</a></li>
		<li><a href="#tgs4.1.1.2">1.2 请求包体</a></li>
        <li><a href="#tgs4.1.1.3">1.3  XML请求示例</a></li>
      </ul>
      </li>
	  <li><a href="#tgs4.1.2">2. 第三方AS响应</a>
      <ul>
        <li><a href="#tgs4.1.2.1">2.1 响应包体</a></li>
		<li><a href="#tgs4.1.2.2">2.2 XML响应示例</a></li>
      </ul>
      </li>
    </ul>
  </div>
