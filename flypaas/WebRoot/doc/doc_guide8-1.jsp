...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        <li  class="active">
        	...
        	<dl>
                ...
                <dd><a href="<%=path%>/doc/doc_guide8-1.jsp" class="active">开发者资质审核规范</a></dd>                   
    ...
    <div class="doc_txt doc_guide">
      <div class="pathbox"><p><a href="<%=path%>/doc/doc.jsp">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_guide4-1.jsp">新手指引</a> > <span>开发者资质审核规范</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">开发者资质审核规范</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgg8.1.1">资质证明信息填写规范</h3>
        <p>1. 资质证明文件必须真实有效、完整、清晰、无其他特殊标记。</p>
        <p>2. 开发者名称、证件号码与资质文件上信息完全一致。公司简称、证件号错误均无法通过。<br />
                        营业执照样本：<br />
        <img src="<%=path%>/doc/images/doc_img55.png" width="80%" />                
        </p>
        <h3 id="tgg8.1.2">常见资质审核驳回问题</h3>
        <p>1. 在资质审核未通过，提示“该用户的证件号码已经被注册，且已审核通过，不能进行再次审核”怎么办？<br />
                        答：在快传融合通讯开放平台中，每个证件号只允许注册一个开发者账号，如发现您的营业执照号已注册，建议您与您公司同事确认是否已注册开发者。如果不是，请联系快传团队。
        </p>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgg8.1.1">1. 资质证明信息填写规范</a></li>
      <li><a href="#tgg8.1.2">2. 常见资质审核驳回问题</a></li>   	  
    </ul>
  </div>
</div>
