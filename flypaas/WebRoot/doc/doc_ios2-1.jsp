...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				<dd><a href="<%=path%>/doc/doc_ios2-1.jsp" class="active">初始化及配置</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_ios5-1.jsp">iOS SDK</a> > <a href="<%=path%>/doc/doc_ios2-1.jsp">初始化及配置接口</a> > <span>初始化及配置</span></p></div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">SDK初始化和配置</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgi2.1.1">1. 初始化实例</h3>
        <pre>
          <code>
/**
 *初始化实例
 * @param delegate  UCSEventDelegate回调代理即服务器连接成功或者服务器连
 *                 接失败的回调函数实例对象
 * @return UCSService 实例对象
 */
<span class="key_label">- (UCSService *)initWithDelegate:(id&lt;UCSEventDelegate&gt;)delegate;</span></code>
        </pre>
        <h3 id="tgi2.1.2">2. 设置代理</h3>
        <pre>
          <code>
/**
 *设置代理
 ...
 * @return void
 */
<span class="key_label">-(void)setDelegate:(id&lt;UCSEventDelegate&gt;)delegate;</span></code>
        </pre>
        <h3 id="tgi2.1.3">3. 连接云平台</h3>
        <pre>
          <code>
/**
 *连接云平台
 ...
 * @return NSInteger  0成功；非0 失败
 */
<span class="key_label">-(NSInteger)connect:(NSString *)accountSid  withAccountToken:(NSString *)accountToken  withClientNumber:(NSString *)ClientNumber  withClientPwd:(NSString *)ClientPwd; </span></code>
        </pre>
        <h3 id="tgi2.1.4">4. 断开云平台连接</h3>
        <pre>
          <code>
/**
 * 断开与云平台的连接
 ...
 * @return void 
 */
<span class="key_label">- (void)uninit;</span></code>
        </pre>
		<h3 id="tgi2.1.5">5. 连接云平台(token)</h3>
        <pre>
          <code>
/**
 * 连接云平台
 ...
 * @return NSInteger  0成功；非0 失败
 */
<span class="key_label">-(NSInteger)connect:(NSString *)token;</span></code>
        </pre>
		<!--<h3 id="tgi2.1.6">6. 连接云平台(token 自定义IP与端口)</h3>
        <pre>
          <code>
/**
 * 连接云平台
 * @param host_addr  远程IP或域名
 * @param host_port  远程机器端口
 * @param token  开发者账户密码
 * @return NSInteger  0成功；非0 失败
 */
<span class="key_label">-(NSInteger)connect:(NSString*)host_addr withPort:(NSString*)host_port withClientNumber:(NSString *)ClientNumber withToken:(NSString *)token;</span></code>
        </pre>-->
		<h3 id="tgi2.1.7">6. 获取连接云平台状态</h3>
        <pre>
          <code>
/**
 * 获取连接云平台状态
 ...
 */
<span class="key_label">- (BOOL)isConnected;</span></code>
        </pre>
		<h3 id="tgi2.1.8">7. 获取SDK版本号</h3>
        <pre>
          <code>
/**
 * 获取SDK版本号
 * @return NSString 
 */
<span class="key_label">- (NSString*) getUCSSDKVersion;</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgi2.1.1">1. 初始化实例</a></li>
	  <li><a href="#tgi2.1.2">2. 设置代理</a></li>
	  <li><a href="#tgi2.1.3">3. 连接云平台</a></li>
	  <li><a href="#tgi2.1.4">4. 断开云平台连接</a></li>
	  <li><a href="#tgi2.1.5">5. 连接云平台(token)</a></li>
	  <!--<li><a href="#tgi2.1.6">6. 连接云平台(token 自定义IP与端口)</a></li>-->
	  <li><a href="#tgi2.1.7">6. 获取连接云平台状态</a></li>
	  <li><a href="#tgi2.1.8">7. 获取SDK版本号</a></li>
    </ul>
  </div>
</div>
