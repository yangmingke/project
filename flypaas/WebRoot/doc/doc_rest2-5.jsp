...
<title>以Client账号方式查询Client信息</title>
...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd><a href="<%=path%>/doc/doc_rest2-5.jsp" class="active">Client信息查询(Client账号)</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_rest1-1.jsp">REST API</a> > <a href="<%=path%>/doc/doc_rest2-1.jsp">账户管理</a> > <span>Client信息查询(Client账号)</span></p>
      </div>
      <div class="display_tit">
        <h1 style="width:350px;"><span class="intro">以Client账号方式查询Client信息</span></h1>
      </div>
      <div class="display_ctn">
        <p>通过HTTPS GET方式提交请求，快传融合通讯开放平台收到请求后根据Client名称查询并返回Client信息。 </p>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            ...
            <tr>
              ...
              <td>String</td>
              <td>必选</td>
              <td><span>clientNumber号码</span></td>
            </tr>
          </tbody>
        </table>
