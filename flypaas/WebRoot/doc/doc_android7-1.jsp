...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
   <div class="doc_menu">
       ...
       <ul>
        ...
        <li class="active">
        	...
        	<dl>
				...
				<dd><a href="<%=path%>/doc/doc_android7-1.jsp" class="active">视频通话控制接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_android6-1.jsp">Android SDK</a> > <span>视频通话控制接口</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">视频通话控制接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tga7.1.1">1. 初始化视频配置</h3>
        <pre>
          <code>
/**
 * 初始化视频设置
 ...
 * @return void  
 */
<span class="key_label">UCSCall.initCameraConfig(Activity mActivity,int width,int height ,int maxFramerate,int startBitrate,LinearLayout remoteLinearLayout,LinearLayout localLinearLayout)</span></code>
        </pre>
        <h3 id="tga7.1.2">2. 刷新视频显示</h3>
        <pre>
          <code>
/**
 * 刷新视频显示
 ...
 */
<span class="key_label">UCSCall.refreshCamera (UCSCameraType cameraType)</span></code>
        </pre>
        <h3 id="tga7.1.3">3. 获取摄像头数量</h3>
        <pre>
          <code>
/**
 * 获取摄像头数量
 * @return:返回摄像头数量  
 */
<span class="key_label">UCSCall.getCameraNum()</span></code>
        </pre>
        <h3 id="tga7.1.4">4. 切换摄像头</h3>
        <pre>
          <code>
/**
 * 切换摄像头
 ...
 * @return 0:成功     其它：失败
 */
<span class="key_label">UCSCall. switchCameraDevice (int cameraIndex)</span></code>
        </pre>
        <h3 id="tga7.1.5">5. 打开摄像头</h3>
        <pre>
          <code>
/**
 * 打开摄像头
 ...
 *  @ return 0:成功     其它：失败
 */
<span class="key_label">UCSCall.openCamera(UCSCameraType camera)</span></code>
        </pre>
        <h3 id="tga7.1.6">6. 关闭摄像头</h3>
        <pre>
          <code>
/**
 * 关闭摄像头
 ...
 *  @return 0:成功     其它：失败
 */
<span class="key_label">UCSCall.closeCamera(UCSCameraType camera)</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tga7.1.1">1. 初始化视频配置</a></li>
      <li><a href="#tga7.1.2">2. 刷新视频显示</a></li>
	  <li><a href="#tga7.1.3">3. 获取摄像头数量</a></li>
      <li><a href="#tga7.1.4">4. 切换摄像头</a></li>
	  <li><a href="#tga7.1.5">5. 打开摄像头</a></li>
      <li><a href="#tga7.1.6">6. 关闭摄像头</a></li>
    </ul>
  </div>
</div>
