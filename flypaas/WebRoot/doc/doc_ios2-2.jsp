...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd class="last"><a href="<%=path%>/doc/doc_ios2-2.jsp" class="active">初始化及配置代理接口</a></dd>
        			</dl>
        		</dd>
        		<dd class="parent">
        			<a href="#"><em>VoIP接口</em></a>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_ios5-1.jsp">iOS SDK</a> > <a href="<%=path%>/doc/doc_ios2-1.jsp">初始化及配置接口</a> ><span>初始化及配置代理接口</span></p></div>
      <div class="display_tit">
        <h1 style="width:320px;"><span class="intro">初始化及配置接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgi2.2.1">1. 连接成功</h3>
        <pre>
          <code>
/**
 *连接云平台成功代理
 * @param result 连接成功的状态码 
 * @return void 
 */
<span class="key_label">- (void)onConnectionSuccessful:(NSInteger)result; </span></code>
        </pre>
        <h3 id="tgi2.2.2">2. 连接失败</h3>
        <pre>
          <code>
/**
 *连接云平台失败代理
 * @param reason 连接失败的状态码 
 * @return void 
 */
<span class="key_label">-(void)onConnectionFailed:(NSInteger)reason; </span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgi2.2.1">1. 连接成功</a></li>
	  <li><a href="#tgi2.2.2">2. 连接失败</a></li>
    </ul>
  </div>
</div>
