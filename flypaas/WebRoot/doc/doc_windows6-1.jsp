...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
       ...
       <ul>
        ...
        <li  class="active">
        	...
        	<dl>
				...
				<dd><a href="<%=path%>/doc/doc_windows6-1.jsp" class="active">视频能力接口</a></dd>
        	</dl>
        </li>
        <li>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_windows5-1.jsp">Windows SDK</a> > <span>视频能力接口</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">视频能力接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgw6.1.1">1. 设置显示窗口</h3>
        <pre>
          <code>
/*
  函数名  : Ucs_setVideoHandle
  功能    : 设置显示窗口句柄
  参数    : [IN]  pLocalVideo	: 本地图像
            [IN]  pRemoteVideo	: 远程图像
  返回值  : 0：成功；非0:失败
*/
<span class="key_label">UCSCLIENT_API int Ucs_setVideoHandle(void *pLocalVideo, void *pRemoteVideo);</span></code>
        </pre>
        <h3 id="tgw6.1.2">2. 获取摄像头数量</h3>
        <pre>
          <code>
/*
  ...
  返回值  : 当前摄像头数量
*/
<span class="key_label">UCSCLIENT_API int Ucs_getCameraNum();</span></code>
        </pre>
        <h3 id="tgw6.1.3">3. 获取摄像头信息</h3>
        <pre>
          <code>
/*
  ...
  返回值  : 0：成功；非0:失败
*/
<span class="key_label">UCSCLIENT_API int Ucs_getCameraInfo(int index, UCS_CAMERAINFO *info);</span></code>
        </pre>
		<h3 id="tgw6.1.4">4. 获取当前摄像头信息</h3>
        <pre>
          <code>
/*
  ...
  返回值  : 当前摄像头索引
*/
<span class="key_label">UCSCLIENT_API int Ucs_getCurCamera ();</span></code>
        </pre>
		<h3 id="tgw6.1.5">5. 切换当前摄像头</h3>
        <pre>
          <code>
/*
  ...
  返回值  : 0：成功；非0:失败
*/
<span class="key_label">UCSCLIENT_API int Ucs_setCameraDevice(const UCS_CAMERADEVICE *video);</span></code>
        </pre>
		<h3 id="tgw6.1.6">6. 打开视频</h3>
        <pre>
          <code>
/*
  函数名  : Ucs_openVideo
  ...
  返回值  : 0：成功；非0:失败
*/
<span class="key_label">UCSCLIENT_API int Ucs_openVideo(const int mode);</span></code>
        </pre>
		<h3 id="tgw6.1.7">7. 关闭视频</h3>
        <pre>
          <code>
/*
  函数名  : Ucs_closeVideo
  ...
  返回值  : 0：成功；非0:失败
*/
<span class="key_label">UCSCLIENT_API int Ucs_closeVideo(const int mode);</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgw6.1.1">1. 设置显示窗口</a></li>
	  <li><a href="#tgw6.1.2">2. 获取摄像头数量</a></li>
	  <li><a href="#tgw6.1.3">3. 获取摄像头信息</a></li>
	  <li><a href="#tgw6.1.4">4. 获取当前摄像头信息</a></li>
	  <li><a href="#tgw6.1.5">5. 切换当前摄像头</a></li>
	  <li><a href="#tgw6.1.6">6. 打开视频</a></li>
	  <li><a href="#tgw6.1.7">7. 关闭视频</a></li>
    </ul>
  </div>
</div>
