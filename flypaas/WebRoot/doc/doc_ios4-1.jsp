...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				<dd><a href="<%=path%>/doc/doc_ios4-1.jsp" class="active">IM能力接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_ios5-1.jsp">iOS SDK</a> > <a href="<%=path%>/doc/doc_ios4-1.jsp">IM接口</a> > <span>IM能力接口</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">IM能力接口</span></h1>
      </div>
      <div class="display_ctn">
        <p>目的是提供发送IM的能力接口。支持各种类型的IM消息，并且易于扩展。</p>
        <h3 id="tgi4.1.1">1. 发送IM消息</h3>
        <pre>
          <code>
/**
 *发送IM消息
...
*/
<span class="key_label">- (NSString) sendUcsMessage:(NSString*) receiver  andText:(NSString*) text andFilePath:(NSString*) filePath  andExpandData:( NSInterger ) msgType</span></code>
        </pre>
        <h3 id="tgi4.1.2">2. 开始录制音频</h3>
        <pre>
          <code>
/**
 *开始录制音频
 ...
 */
<span class="key_label">- (BOOL*) startVoiceRecord: (NSString*) filePath </span></code>
        </pre>
        <h3 id="tgi4.1.3">3. 停止录制语音</h3>
        <pre>
          <code>
/**
 *停止录制音频
 ...
 * @return void
 */
<span class="key_label">-(void) stopVoiceRecord ;</span></code>
        </pre>
        <h3 id="tgi4.1.4">4. 播放语音</h3>
        <pre>
          <code>
/**
 *播放语音
 ...
 * @return void
 */
<span class="key_label">-(void) playVoice :(NSString*) filePath</span></code>
        </pre>
        <h3 id="tgi4.1.5">5. 停止播放语音</h3>
        <pre>
          <code>
/**
 *停止播放语音
 ...
 * @return void
 */
<span class="key_label">-(void) stopVoice；</span></code>
        </pre>
        <h3 id="tgi4.1.6">6. 获取语音时长</h3>
        <pre>
          <code>
/**
 *获取语音时长
 ...
 */
<span class="key_label">-(long) getVoiceDuration:(String filePath)</span></code>
        </pre>
        <h3 id="tgi4.1.7">7. 下载附件API</h3>
        <pre>
          <code>
/**
 *下载附件
 ...
 * @return void  
 */
<span class="key_label">- (void) downloadAttached:(NSString*) fileUrl andFilePath:(NSString*) filePath  andMsgId:(NSString*) msgId</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgi4.1.1">1. 发送IM消息</a></li>
	  <li><a href="#tgi4.1.2">2. 开始录制音频</a></li>
	  <li><a href="#tgi4.1.3">3. 停止录制语音</a></li>
	  <li><a href="#tgi4.1.4">4. 播放语音</a></li>
	  <li><a href="#tgi4.1.5">5. 停止播放语音</a></li>
	  <li><a href="#tgi4.1.6">6. 获取语音时长</a></li>
	  <li><a href="#tgi4.1.7">7. 下载附件API</a></li>
    </ul>
  </div>
</div>
