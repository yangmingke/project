...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        	...
        	<dl>
        		...
        		<dd class="parent">
        			...
        			<dl class="child" style="display:block;">
        				...
        				<dd class="last"><a href="<%=path%>/doc/doc_ios4-2.jsp" class="active">IM能力代理接口</a></dd>
        			</dl>
        		</dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_ios5-1.jsp">iOS SDK</a> > <a href="<%=path%>/doc/doc_ios4-1.jsp">IM接口</a> > <span>IM能力代理接口</span></p></div>
      <div class="display_tit">
        <h1><span class="intro">IM能力代理接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgi4.2.1">1. 收到IM消息</h3>
        <pre>
          <code>
/**
 *收到IM消息代理
 ...
 * @return void  
 */
<span class="key_label">-(void)onReceiveUcsMessage:(UCSReason *)reason withMsg:( UCSMessage *)msg</span></code>
        </pre>
        <h3 id="tgi4.2.2">2. 发送IM消息</h3>
        <pre>
          <code>
/**
 *发送IM消息代理
 ...
 * @return void  
 */
<span class="key_label">-(void)onSendUcsMessage:(UCSReason*)reason  withData:( UCSMessage  *)data</span></code>
        </pre>
        <h3 id="tgi4.2.3">3. 下载IM附件</h3>
        <pre>
          <code>
/**
 *下载IM附件代理
 ...
 * @return void  
 */
<span class="key_label">-(void)onDownloadAttached:
(UCSReason*)reason withFilePath:(NSString*)filePath  andMsgId:(NSString*) msgId</span></code>
        </pre>
        <h3 id="tgi4.2.4">4. 播放录音结束</h3>
        <pre>
          <code>
/**
 *播放语音结束代理
 ...
 * @return void
 */
<span class="key_label">-(void) onFinishedPlayingVoice</span></code>
        </pre>
        <h3 id="tgi4.2.5">5. 停止录音</h3>
        <pre>
          <code>
/**
 *停止录音代理
 ...
 * @return void
 */
<span class="key_label">-(void)onStopVoiceRecord: (NSInterger) duration</span></code>
        </pre>
      </div>
    </div>
  </div>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgi4.2.1">1. 收到IM消息</a></li>
	  <li><a href="#tgi4.2.2">2. 发送IM消息</a></li>
	  <li><a href="#tgi4.2.3">3. 下载IM附件</a></li>
	  <li><a href="#tgi4.2.4">4. 播放录音结束</a></li>
	  <li><a href="#tgi4.2.5">5. 停止录音</a></li>
    </ul>
  </div>
</div>
