...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
        ...
        <li>
         ...
         <li class="active">
        	...
        	<dl>
				...
				<dd><a href="<%=path%>/doc/doc_ios8-1.jsp" class="active">用户在线状态能力代理接口</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox"><p><a href="<%=path%>/document">帮助文档首页</a> > <a href="<%=path%>/doc/doc_ios5-1.jsp">iOS SDK</a> > <span>用户在线状态能力代理接口</span></p></div>
      <div class="display_tit">
        <h1 style="width:300px"><span class="intro">用户在线状态能力代理接口</span></h1>
      </div>
      <div class="display_ctn">
        <h3 id="tgi8.1.1">1. 查询用户在线回调方法</h3>
        <pre>
          <code>
/**
 * @param Result 在线状态结果（client或者phone number）。
 * @param UCSUserState 单个号码在线状态类型
 * @Return NULL
 */
<span class="key_label">- (void)onUserState:(NSMutableArray *)Result class:(NSString *)UCSUserState; </span></code>
        </pre>
      </div>
    </div>
  </div>
