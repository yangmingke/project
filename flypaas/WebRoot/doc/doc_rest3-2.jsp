...
<div class="middle mid_box doc_box">
  <div class="display_wrapper">
          ...
          <dl>
            ...
            <dd class="parent"> <a href="javascript:void(0)" class="active"><em>呼叫</em></a>
              <dl class="child" style="display:block;">
                ...
                <dd><a href="<%=path%>/doc/doc_rest3-2.jsp" class="active">语音验证码</a></dd>
    ...
    <div class="doc_txt">
      <div class="pathbox">
        <p><a href="<%=path%>/document">帮助文档首页</a> >  <a href="<%=path%>/doc/doc_rest1-1.jsp">REST API</a> > <a href="<%=path%>/doc/doc_rest3-1.jsp">呼叫</a> > <span>语音验证码</span></p>
      </div>
      <div class="display_tit">
        <h1><span class="intro">语音验证码</span></h1>
      </div>
      <div class="display_ctn">
        <p>语音验证码是快传融合通讯开放平台提供的一种语音通知能力，可以使用此REST API实现语音验证码功能。</p>
        <p>请通过HTTPS POST方式提交请求，快传融合通讯开放平台收到请求后，向对象电话终端发起呼叫，接通电话后将播放指定语音验证码序列</p>
        <h3 id="tgr3.2.1">1.1 请求</h3>
        <b id="tgr3.2.1.1">• 请求地址</b>
        <p class="code"><span>/{SoftVersion}/Accounts/{accountSid}/Calls/voiceCode</span></p>
        <b id="tgr3.2.1.2">• 请求包头</b>
        <p><span>详情请查阅统一请求包头，并使用开发者账号进行验证。</span></p>
        <b id="tgr3.2.1.3">• 请求包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            ...
            <tr>
              ...
              <td>String</td>
              <td>必选</td>
              <td><span>验证码内容，为数字0~9，字母a~z，特殊字符!(感叹号)、~(波浪号)、@(at)、#(井号)、%(百分号)、$(美元符)、￥(元符号)、^(次方符)、&(与符号)、*(星号)、((左小括号)、)(右小括号)、.(点)、_(下划线)、+(加号)、|(竖线)、-(减号)、&lt;(左尖括号)、&gt;(右尖括号)、?(问号)、[(左中括号)、](右中括号)、{(左大括号)、}(右大括号)，长度4-8位。</span><span>说明：字母不区分大小写，特殊字符均为英文状态下输入(￥符号除外)。</span></td>
            </tr>
            <tr>
              <td>to</td>
              <td>String</td>
              <td>必选</td>
              <td><span>接收号码</span></td>
            </tr>
          </tbody>
        </table>
        <b id="tgr3.2.1.4">• XML请求示例</b>
        <pre>
          <code class="code_fn">
...
&lt;voiceCode&gt;
    ...
    &lt;verifyCode&gt;7116&lt;/verifyCode&gt;
    &lt;to&gt;18612345678&lt;/to&gt;
&lt;/voiceCode&gt;</code>
        </pre>
        <b id="tgr3.2.1.5">• JSON请求示例</b>
        <pre>
          <code class="code_fn">
...

{
 "voiceCode"  : {
    ...
    "verifyCode" : "4342"
        ...
        <h3 id="tgr3.2.2">1.2 响应</h3>
        <b id="tgr3.2.2.1">• 响应包体</b>
        <table cellspacing="0" cellpadding="0" border="0" width="100%;">
          <tbody>
            <tr>
              <th style="width:20%;">属性</th>
            ...
            <tr>
              ...
              <td>String</td>
              <td>必选</td>
              <td><span>一个由32个字符组成的唯一电话标识符</span></td>
            </tr>
            <tr>
              <td>createDate</td>
              <td>String</td>
...
<div class="doc_aside" id="doc_aside">
  ...
  <div class="aside_ctn">
    <ul>
      <li><a href="#tgr3.2.1">1. 请求</a>
      <ul>
        <li><a href="#tgr3.2.1.1">1.1 请求地址</a></li>
		<li><a href="#tgr3.2.1.2">1.2 请求包头</a></li>
		<li><a href="#tgr3.2.1.3">1.3 请求包体</a></li>
		<li><a href="#tgr3.2.1.4">1.4 XML请求示例</a></li>
		<li><a href="#tgr3.2.1.5">1.5 JSON请求示例</a></li>        
      </ul>
      </li>
	  <li><a href="#tgr3.2.2">2. 响应</a>
      <ul>
        <li><a href="#tgr3.2.2.1">2.1 响应包体</a></li>
		<li><a href="#tgr3.2.2.2">2.2 XML响应示例</a></li>
		<li><a href="#tgr3.2.2.3">2.3 JSON响应示例</a></li>     
      </ul>
      </li>
    </ul>
  </div>
